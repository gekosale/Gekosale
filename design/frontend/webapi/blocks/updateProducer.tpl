<div class="page-header">
	<h1 id="updateProducer">updateProducer <small>dodanie producenta do sklepu</small></h1>
</div>
...
$response = $client->updateProducer($request);
...
<td>success</td>
<td>int</td>
<td>Status operacji 1 oznacza poprawne zaktualizowanie producenta.</td>
</tr>
</tbody>
</table>