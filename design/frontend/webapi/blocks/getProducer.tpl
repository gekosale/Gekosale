<div class="page-header">
	<h1 id="getProducer">getProducer <small>pobieranie informacji o producencie</small></h1>
</div>
...
$id = 2;
$response = $client->getProducer($id);
...
<td>id</td>
<td>int</td>
<td>ID producenta pobrane z danych produktu (getProduct/getProducts) lub listy producentów (getProducers)</td>
</tr>
</tbody>
</table>
