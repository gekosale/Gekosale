{% extends "layout.tpl" %}
{% block content %}
<h2><img src="{{ DESIGNPATH }}_images_panel/icons/modules/invoice-list.png" alt=""/>Integracja kurJerzy.pl</h2>
{% if verified is defined and verified == 0 %}
	...
	<div class="block">
		<p><img src="{{ DESIGNPATH }}_images_panel/logos/kurjerzy_logo.png" /></p>
...
{% else %}
	<ul class="possibilities">
	   <li><a href="{{ URL }}instancemanager" class="button return"><span><img src="{{ DESIGNPATH }}_images_panel/icons/buttons/arrow-left-gray.png" /></span></a></li>
	   {% if disableNavigation is not defined %}<li><a href="#kurjerzy" rel="submit" class="button"><span><img src="{{ DESIGNPATH }}_images_panel/icons/buttons/check.png" alt=""/>{% trans %}TXT_SAVE{% endtrans %}</span></a></li>{% endif %}
	</ul>
