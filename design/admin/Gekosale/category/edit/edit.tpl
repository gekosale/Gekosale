...
<ul class="possibilities">
	...
	<li><a href="#category" class="button show" id="show" rel="show"><span><img src="{{ DESIGNPATH }}_images_panel/icons/datagrid/details.png" alt=""/>{% trans %}TXT_SHOW_IN_SHOP{% endtrans %}</span></a></li>
