...
{% endblock %}
{% block content %}
<h2><img src="{{ DESIGNPATH }}_images_panel/icons/modules/dispatchmethod-edit.png" alt=""/>{% trans %}TXT_EDIT_DISPATCHMETHOD{% endtrans %}</h2>
<ul class="possibilities">
	...
	<li><a href="#dispatchmethod" rel="submit" class="button" title="{% trans %}TXT_SAVE{% endtrans %}"><span><img src="{{ DESIGNPATH }}_images_panel/icons/buttons/check.png" alt=""/>{% trans %}TXT_SAVE{% endtrans %}</span></a></li>
</ul>
{{ form }}
{% endblock %}