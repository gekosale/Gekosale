{% extends "layout.tpl" %}
{% block content %}
<h2><img src="{{ DESIGNPATH }}_images_panel/icons/modules/client-edit.png" alt=""/>{% trans %}TXT_EDIT_CLIENT{% endtrans %}</h2>
<ul class="possibilities">
	...
	<li><a href="{{ URL }}order/add/{{ CURRENT_PARAM }}" class="button" title="{% trans %}TXT_ADD_ORDERS{% endtrans %}"><span><img src="{{ DESIGNPATH }}_images_panel/icons/buttons/add.png" alt=""/>{% trans %}TXT_ADD_ORDERS{% endtrans %}</span></a></li>
	<li><a href="#client" rel="submit" class="button" title="{% trans %}TXT_SAVE{% endtrans %}"><span><img src="{{ DESIGNPATH }}_images_panel/icons/buttons/check.png" alt=""/>{% trans %}TXT_SAVE{% endtrans %}</span></a></li>
</ul>
