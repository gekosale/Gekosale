...
/**
 * Walidator do określenia minimalnej wielkości pliku
 * 
 * @category   Image
 * @package    Image_Validator
 * @author     Krzysztof Kardasz <krzysztof.kardasz@gmail.com>
 * @copyright  Copyright (c) 2008 Krzysztof Kardasz
 */
class Image_Validator_MinFileSize extends Image_Validator_Abstract
{
    /**
    ...
    {
        $this->size    = $size;
        $this->message = 'rozmiar pliku "%s" jest mniejszy niż ' . round(($size/1024), 2) . 'KB';
    }
