...
use Gekosale\Plugin\Blog\Model\ORM\Map\BlogI18nTableMap;
...
/**
 * Base class that represents a query for the 'blog_i18n' table.
 *
 * 
 *
 ...
 * @method     ChildBlogI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildBlogI18nQuery leftJoinBlog($relationAlias = null) Adds a LEFT JOIN clause to the query using the Blog relation
 * @method     ChildBlogI18nQuery rightJoinBlog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Blog relation
 * @method     ChildBlogI18nQuery innerJoinBlog($relationAlias = null) Adds a INNER JOIN clause to the query using the Blog relation
 *
 * @method     ChildBlogI18n findOne(ConnectionInterface $con = null) Return the first ChildBlogI18n matching the query
 * @method     ChildBlogI18n findOneOrCreate(ConnectionInterface $con = null) Return the first ChildBlogI18n matching the query, or a new ChildBlogI18n object populated from the query conditions when no match is found
 *
...
abstract class BlogI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Blog\Model\ORM\Base\BlogI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Blog\\Model\\ORM\\BlogI18n', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildBlogI18nQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildBlogI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof \Gekosale\Plugin\Blog\Model\ORM\BlogI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Blog\Model\ORM\BlogI18nQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildBlogI18n|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = BlogI18nTableMap::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
            // the object is already in the instance pool
            return $obj;
        }
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(BlogI18nTableMap::DATABASE_NAME);
        }
     ...
     *
     * @return   ChildBlogI18n A model object, or null if the key is not found
     */
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            $obj = new ChildBlogI18n();
            $obj->hydrate($row);
            BlogI18nTableMap::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
    ...
    {
        $this->addUsingAlias(BlogI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(BlogI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(BlogI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(BlogI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(BlogI18nTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(BlogI18nTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BlogI18nTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BlogI18nTableMap::COL_LOCALE, $locale, $comparison);
    }
    ...
    public function filterByBlog($blog, $comparison = null)
    {
        if ($blog instanceof \Gekosale\Plugin\Blog\Model\ORM\Blog) {
            return $this
                ->addUsingAlias(BlogI18nTableMap::COL_ID, $blog->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BlogI18nTableMap::COL_ID, $blog->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return ChildBlogI18nQuery The current query, for fluid interface
     */
    public function joinBlog($relationAlias = null, $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function useBlogQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
     ...
     *
     * @param   ChildBlogI18n $blogI18n Object to remove from the list of results
     *
     * @return ChildBlogI18nQuery The current query, for fluid interface
     */
    public function prune($blogI18n = null)
    {
        if ($blogI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(BlogI18nTableMap::COL_ID), $blogI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(BlogI18nTableMap::COL_LOCALE), $blogI18n->getLocale(), Criteria::NOT_EQUAL);
    ...
    /**
     * Deletes all rows from the blog_i18n table.
     *
    ...
    {
        if (null === $con) {
            $con = Propel::getServiceContainer()->getWriteConnection(BlogI18nTableMap::DATABASE_NAME);
        }
        ...
        try {
            ...
            BlogI18nTableMap::clearRelatedInstancePool();
    ...
    /**
     * Performs a DELETE on the database, given a ChildBlogI18n or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildBlogI18n object or primary key or array of primary keys
     ...
     */
     public function delete(ConnectionInterface $con = null)
     {
        ...
        $criteria->setDbName(BlogI18nTableMap::DATABASE_NAME);
        ...
        BlogI18nTableMap::removeInstanceFromPool($criteria);
