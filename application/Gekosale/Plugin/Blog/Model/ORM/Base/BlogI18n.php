...
abstract class BlogI18n implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Blog\\Model\\ORM\\Map\\BlogI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Blog\Model\ORM\Base\BlogI18n object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>BlogI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>BlogI18n</code>, delegates to
     * <code>equals(BlogI18n)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return BlogI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BlogI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[BlogI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BlogI18nTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BlogI18nTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BlogI18nTableMap::translateFieldName('Locale', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aBlog !== null && $this->id !== $this->aBlog->getId()) {
            $this->aBlog = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBlogI18nQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BlogI18n::setDeleted()
     * @see BlogI18n::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildBlogI18nQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BlogI18nTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BlogI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(BlogI18nTableMap::COL_LOCALE)) {
    ...
    {
        $pos = BlogI18nTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BlogI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BlogI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = BlogI18nTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(BlogI18nTableMap::DATABASE_NAME);
        $criteria->add(BlogI18nTableMap::COL_ID, $this->id);
        $criteria->add(BlogI18nTableMap::COL_LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Blog\Model\ORM\BlogI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Blog\Model\ORM\BlogI18n Clone of current object.
     * @throws PropelException
     */
    ...
    public function getBlog(ConnectionInterface $con = null)
    {
        if ($this->aBlog === null && ($this->id !== null)) {
            $this->aBlog = ChildBlogQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBlog->addBlogI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BlogI18nTableMap::DEFAULT_STRING_FORMAT);
    }
