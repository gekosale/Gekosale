...
abstract class Translation implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Translation\\Model\\ORM\\Map\\TranslationTableMap';
     ...
     *
     * @return Translation The current object, for fluid interface
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO translation (%s) VALUES (%s)',
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Translation\Model\ORM\Translation (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Translation\Model\ORM\Translation Clone of current object.
     * @throws PropelException
     */
