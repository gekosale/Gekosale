...
abstract class PaymentMethod implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\PaymentMethod\\Model\\ORM\\Map\\PaymentMethodTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\PaymentMethod\Model\ORM\Base\PaymentMethod object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>PaymentMethod</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentMethod</code>, delegates to
     * <code>equals(PaymentMethod)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return PaymentMethod The current object, for fluid interface
     */
    ...
    /**
     * Get the [maximum_amount] column value.
     * 
     * @return   string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_ID] = true;
        }
    ...
    public function setController($v)
    {
        ...
        if ($this->controller !== $v) {
            $this->controller = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_CONTROLLER] = true;
        }
    ...
    /**
     * Set the value of [maximum_amount] column.
     * 
     * @param      string $v new value
     * @return   \Gekosale\Plugin\PaymentMethod\Model\ORM\PaymentMethod The current object (for fluent API support)
     */
    public function setMaximumAmount($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->maximum_amount !== $v) {
            $this->maximum_amount = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_MAXIMUM_AMOUNT] = true;
        }
    ...
    public function setHierarchy($v)
    {
        ...
        if ($this->hierarchy !== $v) {
            $this->hierarchy = $v;
            $this->modifiedColumns[PaymentMethodTableMap::COL_HIERARCHY] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentMethodQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildPaymentMethodQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentMethodTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = PaymentMethodTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        $criteria = new Criteria(PaymentMethodTableMap::DATABASE_NAME);
        $criteria->add(PaymentMethodTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\PaymentMethod\Model\ORM\PaymentMethod (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\PaymentMethod\Model\ORM\PaymentMethod Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDispatchMethodpaymentMethods($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collDispatchMethodpaymentMethods || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDispatchMethodpaymentMethods) {
                ...
                $collDispatchMethodpaymentMethods = DispatchMethodpaymentMethodQuery::create(null, $criteria)
    ...
    public function setDispatchMethodpaymentMethods(Collection $dispatchMethodpaymentMethods, ConnectionInterface $con = null)
    {
        ...
        foreach ($dispatchMethodpaymentMethodsToDelete as $dispatchMethodpaymentMethodRemoved) {
            $dispatchMethodpaymentMethodRemoved->setPaymentMethod(null);
        }
    ...
    public function countDispatchMethodpaymentMethods(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collDispatchMethodpaymentMethods || null !== $criteria || $partial) {
            ...
            $query = DispatchMethodpaymentMethodQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    protected function doAddDispatchMethodpaymentMethod($dispatchMethodpaymentMethod)
    {
        ...
        $dispatchMethodpaymentMethod->setPaymentMethod($this);
    }
    ...
    public function removeDispatchMethodpaymentMethod($dispatchMethodpaymentMethod)
    {
        if ($this->getDispatchMethodpaymentMethods()->contains($dispatchMethodpaymentMethod)) {
            ...
            $dispatchMethodpaymentMethod->setPaymentMethod(null);
        }
     ...
     * @return Collection|ChildDispatchMethodpaymentMethod[] List of ChildDispatchMethodpaymentMethod objects
     */
    public function getDispatchMethodpaymentMethodsJoinDispatchMethod($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = DispatchMethodpaymentMethodQuery::create(null, $criteria);
    ...
    public function getPaymentMethodShops($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collPaymentMethodShops || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPaymentMethodShops) {
                ...
                $collPaymentMethodShops = ChildPaymentMethodShopQuery::create(null, $criteria)
                    ->filterByPaymentMethod($this)
                    ->find($con);
    ...
    public function setPaymentMethodShops(Collection $paymentMethodShops, ConnectionInterface $con = null)
    {
        ...
        foreach ($paymentMethodShopsToDelete as $paymentMethodShopRemoved) {
            $paymentMethodShopRemoved->setPaymentMethod(null);
        }
    ...
    public function countPaymentMethodShops(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collPaymentMethodShops || null !== $criteria || $partial) {
            ...
            $query = ChildPaymentMethodShopQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    protected function doAddPaymentMethodShop($paymentMethodShop)
    {
        ...
        $paymentMethodShop->setPaymentMethod($this);
    }
    ...
    public function removePaymentMethodShop($paymentMethodShop)
    {
        if ($this->getPaymentMethodShops()->contains($paymentMethodShop)) {
            ...
            $paymentMethodShop->setPaymentMethod(null);
        }
     ...
     * @return Collection|ChildPaymentMethodShop[] List of ChildPaymentMethodShop objects
     */
    public function getPaymentMethodShopsJoinShop($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPaymentMethodShopQuery::create(null, $criteria);
