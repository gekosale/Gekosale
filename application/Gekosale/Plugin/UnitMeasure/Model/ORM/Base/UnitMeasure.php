...
abstract class UnitMeasure implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\UnitMeasure\\Model\\ORM\\Map\\UnitMeasureTableMap';
    ...
    /**
     * Compares this with another <code>UnitMeasure</code> instance.  If
     * <code>obj</code> is an instance of <code>UnitMeasure</code>, delegates to
     * <code>equals(UnitMeasure)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return UnitMeasure The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UnitMeasureTableMap::COL_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUnitMeasureQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UnitMeasure::setDeleted()
     * @see UnitMeasure::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildUnitMeasureQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UnitMeasureTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = UnitMeasureTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UnitMeasure'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UnitMeasure'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(UnitMeasureTableMap::DATABASE_NAME);
        $criteria->add(UnitMeasureTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\UnitMeasure\Model\ORM\UnitMeasure (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\UnitMeasure\Model\ORM\UnitMeasure Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProducts(Collection $products, ConnectionInterface $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setUnitMeasure(null);
        }
     ...
     * Otherwise if this UnitMeasure is new, it will return
     * an empty collection; or if this UnitMeasure has previously
     * been saved, it will retrieve related Products from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UnitMeasure.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
