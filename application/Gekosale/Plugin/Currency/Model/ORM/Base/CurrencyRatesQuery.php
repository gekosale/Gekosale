...
use \Exception;
use \PDO;
use Gekosale\Plugin\Currency\Model\ORM\CurrencyRates as ChildCurrencyRates;
...
abstract class CurrencyRatesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Currency\Model\ORM\Base\CurrencyRatesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Currency\\Model\\ORM\\CurrencyRates', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\Currency\Model\ORM\CurrencyRatesQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Currency\Model\ORM\CurrencyRatesQuery();
        if (null !== $modelAlias) {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByCurrencyFrom($currencyFrom = null, $comparison = null)
    {
        if (is_array($currencyFrom)) {
            ...
            if (isset($currencyFrom['min'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_FROM, $currencyFrom['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($currencyFrom['max'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_FROM, $currencyFrom['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_FROM, $currencyFrom, $comparison);
    }
    ...
    public function filterByCurrencyTo($currencyTo = null, $comparison = null)
    {
        if (is_array($currencyTo)) {
            ...
            if (isset($currencyTo['min'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_TO, $currencyTo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($currencyTo['max'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_TO, $currencyTo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_CURRENCY_TO, $currencyTo, $comparison);
    }
    ...
    public function filterByExchangeRate($exchangeRate = null, $comparison = null)
    {
        if (is_array($exchangeRate)) {
            ...
            if (isset($exchangeRate['min'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_EXCHANGE_RATE, $exchangeRate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($exchangeRate['max'])) {
                $this->addUsingAlias(CurrencyRatesTableMap::COL_EXCHANGE_RATE, $exchangeRate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CurrencyRatesTableMap::COL_EXCHANGE_RATE, $exchangeRate, $comparison);
    }
    ...
    {
        if ($currencyRates) {
            $this->addUsingAlias(CurrencyRatesTableMap::COL_ID, $currencyRates->getId(), Criteria::NOT_EQUAL);
        }
