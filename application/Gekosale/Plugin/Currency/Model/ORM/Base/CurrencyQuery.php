...
abstract class CurrencyQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, NAME, CURRENCY_SYMBOL, DECIMAL_SEPARATOR, THOUSAND_SEPARATOR, POSITIVE_PREFFIX, POSITIVE_SUFFIX, NEGATIVE_PREFFIX, NEGATIVE_SUFFIX, DECIMAL_COUNT FROM currency WHERE ID = :p0';
        try {
