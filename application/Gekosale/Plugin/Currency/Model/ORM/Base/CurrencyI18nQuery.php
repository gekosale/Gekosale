...
use Gekosale\Plugin\Currency\Model\ORM\Map\CurrencyI18nTableMap;
...
abstract class CurrencyI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Currency\Model\ORM\Base\CurrencyI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Currency\\Model\\ORM\\CurrencyI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $this->addUsingAlias(CurrencyI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(CurrencyI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(CurrencyI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(CurrencyI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(CurrencyI18nTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(CurrencyI18nTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CurrencyI18nTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CurrencyI18nTableMap::COL_LOCALE, $locale, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CurrencyI18nTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByCurrency($currency, $comparison = null)
    {
        if ($currency instanceof \Gekosale\Plugin\Currency\Model\ORM\Currency) {
            return $this
                ->addUsingAlias(CurrencyI18nTableMap::COL_ID, $currency->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CurrencyI18nTableMap::COL_ID, $currency->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($currencyI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CurrencyI18nTableMap::COL_ID), $currencyI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(CurrencyI18nTableMap::COL_LOCALE), $currencyI18n->getLocale(), Criteria::NOT_EQUAL);
