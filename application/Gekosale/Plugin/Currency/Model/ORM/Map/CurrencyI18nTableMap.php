...
use Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n;
use Gekosale\Plugin\Currency\Model\ORM\CurrencyI18nQuery;
...
class CurrencyI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Currency.Model.ORM.Map.CurrencyI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Currency\\Model\\ORM\\CurrencyI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Currency.Model.ORM.CurrencyI18n';
     ...
     */
    const COL_ID = 'currency_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const COL_LOCALE = 'currency_i18n.LOCALE';

    /**
     * the column name for the NAME field
     */
    const COL_NAME = 'currency_i18n.NAME';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CurrencyI18nTableMap::COL_ID, CurrencyI18nTableMap::COL_LOCALE, CurrencyI18nTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CurrencyI18nTableMap::COL_ID => 0, CurrencyI18nTableMap::COL_LOCALE => 1, CurrencyI18nTableMap::COL_NAME => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\Currency\\Model\\ORM\\CurrencyI18n');
        $this->setPackage('Gekosale.Plugin.Currency.Model.ORM');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('ID', 'Id', 'INTEGER' , 'currency', 'ID', true, 10, null);
    ...
    {
        $this->addRelation('Currency', '\\Gekosale\\Plugin\\Currency\\Model\\ORM\\Currency', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n $obj A \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n object.
     ...
     *
     * @param mixed $value A \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CurrencyI18nTableMap::COL_ID);
            $criteria->addSelectColumn(CurrencyI18nTableMap::COL_LOCALE);
            $criteria->addSelectColumn(CurrencyI18nTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Currency\Model\ORM\CurrencyI18n) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CurrencyI18nTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CurrencyI18nTableMap::COL_LOCALE, $value[1]));
