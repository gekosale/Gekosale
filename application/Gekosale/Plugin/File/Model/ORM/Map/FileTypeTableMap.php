...
use Gekosale\Plugin\File\Model\ORM\FileType;
use Gekosale\Plugin\File\Model\ORM\FileTypeQuery;
...
class FileTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.File.Model.ORM.Map.FileTypeTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\File\\Model\\ORM\\FileType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.File.Model.ORM.FileType';
     ...
     */
    const COL_ID = 'file_type.ID';

    /**
     * the column name for the NAME field
     */
    const COL_NAME = 'file_type.NAME';

    /**
     * the column name for the IS_ACTIVE field
     */
    const COL_IS_ACTIVE = 'file_type.IS_ACTIVE';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FileTypeTableMap::COL_ID, FileTypeTableMap::COL_NAME, FileTypeTableMap::COL_IS_ACTIVE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FileTypeTableMap::COL_ID => 0, FileTypeTableMap::COL_NAME => 1, FileTypeTableMap::COL_IS_ACTIVE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\File\\Model\\ORM\\FileType');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FileTypeTableMap::COL_ID);
            $criteria->addSelectColumn(FileTypeTableMap::COL_NAME);
            $criteria->addSelectColumn(FileTypeTableMap::COL_IS_ACTIVE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\File\Model\ORM\FileType) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(FileTypeTableMap::DATABASE_NAME);
            $criteria->add(FileTypeTableMap::COL_ID, (array) $values, Criteria::IN);
        }

        $query = FileTypeQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { FileTypeTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { FileTypeTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(FileTypeTableMap::COL_ID) && $criteria->keyContainsValue(FileTypeTableMap::COL_ID) ) {
