...
use \Exception;
use \PDO;
use Gekosale\Plugin\File\Model\ORM\FileType as ChildFileType;
...
abstract class FileTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\File\Model\ORM\Base\FileTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\File\\Model\\ORM\\FileType', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\File\Model\ORM\FileTypeQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\File\Model\ORM\FileTypeQuery();
        if (null !== $modelAlias) {
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = FileTypeTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            FileTypeTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(FileTypeTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(FileTypeTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(FileTypeTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(FileTypeTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FileTypeTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FileTypeTableMap::COL_NAME, $name, $comparison);
    }
    ...
    {
        if ($fileType) {
            $this->addUsingAlias(FileTypeTableMap::COL_ID, $fileType->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Performs a DELETE on the database, given a ChildFileType or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildFileType object or primary key or array of primary keys
