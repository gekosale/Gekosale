...
class LocaleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Locale.Model.ORM.Map.LocaleTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Locale\\Model\\ORM\\Locale';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Locale.Model.ORM.Locale';
     ...
     */
    const COL_NAME = 'locale.NAME';

    /**
     * the column name for the TRANSLATION field
     */
    const COL_TRANSLATION = 'locale.TRANSLATION';

    /**
     * the column name for the CURRENCY_ID field
     */
    const COL_CURRENCY_ID = 'locale.CURRENCY_ID';

    /**
     * the column name for the FLAG field
     */
    const COL_FLAG = 'locale.FLAG';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Translation', 'CurrencyId', 'Flag', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'name', 'translation', 'currencyId', 'flag', ),
        self::TYPE_COLNAME       => array(LocaleTableMap::COL_ID, LocaleTableMap::COL_NAME, LocaleTableMap::COL_TRANSLATION, LocaleTableMap::COL_CURRENCY_ID, LocaleTableMap::COL_FLAG, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_NAME', 'COL_TRANSLATION', 'COL_CURRENCY_ID', 'COL_FLAG', ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'translation', 'currency_id', 'flag', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Translation' => 2, 'CurrencyId' => 3, 'Flag' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'translation' => 2, 'currencyId' => 3, 'flag' => 4, ),
        self::TYPE_COLNAME       => array(LocaleTableMap::COL_ID => 0, LocaleTableMap::COL_NAME => 1, LocaleTableMap::COL_TRANSLATION => 2, LocaleTableMap::COL_CURRENCY_ID => 3, LocaleTableMap::COL_FLAG => 4, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_NAME' => 1, 'COL_TRANSLATION' => 2, 'COL_CURRENCY_ID' => 3, 'COL_FLAG' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'translation' => 2, 'currency_id' => 3, 'flag' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\Locale\\Model\\ORM\\Locale');
        ...
        $this->addColumn('FLAG', 'Flag', 'VARCHAR', true, 45, null);
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('LocaleShop', '\\Gekosale\\Plugin\\Locale\\Model\\ORM\\LocaleShop', RelationMap::ONE_TO_MANY, array('id' => 'locale_id', ), 'CASCADE', null, 'LocaleShops');
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to locale     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocaleTableMap::COL_NAME);
            $criteria->addSelectColumn(LocaleTableMap::COL_TRANSLATION);
            $criteria->addSelectColumn(LocaleTableMap::COL_CURRENCY_ID);
            $criteria->addSelectColumn(LocaleTableMap::COL_FLAG);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Locale\Model\ORM\Locale) { // it's a model object
        ...
        if ($values instanceof Criteria) { LocaleTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { LocaleTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(LocaleTableMap::COL_ID) && $criteria->keyContainsValue(LocaleTableMap::COL_ID) ) {
