...
abstract class ProducerShop implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Producer\\Model\\ORM\\Map\\ProducerShopTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Producer\Model\ORM\Base\ProducerShop object.
     */
    ...
    /**
     * Compares this with another <code>ProducerShop</code> instance.  If
     * <code>obj</code> is an instance of <code>ProducerShop</code>, delegates to
     * <code>equals(ProducerShop)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProducerShop The current object, for fluid interface
     */
     ...
     * @return   \Gekosale\Plugin\Producer\Model\ORM\ProducerShop The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProducerShopTableMap::COL_ID] = true;
        }
    ...
    public function setProducerId($v)
    {
        ...
        if ($this->producer_id !== $v) {
            $this->producer_id = $v;
            $this->modifiedColumns[ProducerShopTableMap::COL_PRODUCER_ID] = true;
        }
    ...
    public function setShopId($v)
    {
        ...
        if ($this->shop_id !== $v) {
            $this->shop_id = $v;
            $this->modifiedColumns[ProducerShopTableMap::COL_SHOP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProducerShopTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProducerShopTableMap::translateFieldName('ProducerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->producer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProducerShopTableMap::translateFieldName('ShopId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProducerShopTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Producer\Model\ORM\ProducerShop object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProducerShopQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProducerShop::setDeleted()
     * @see ProducerShop::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProducerShopQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProducerShopTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProducerShopTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ProducerShopTableMap::COL_PRODUCER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PRODUCER_ID';
        }
        if ($this->isColumnModified(ProducerShopTableMap::COL_SHOP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SHOP_ID';
        }

        $sql = sprintf(
            'INSERT INTO producer_shop (%s) VALUES (%s)',
    ...
    {
        $pos = ProducerShopTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProducerShop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProducerShop'][$this->getPrimaryKey()] = true;
        $keys = ProducerShopTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProducerShopTableMap::COL_ID)) $criteria->add(ProducerShopTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ProducerShopTableMap::COL_PRODUCER_ID)) $criteria->add(ProducerShopTableMap::COL_PRODUCER_ID, $this->producer_id);
        if ($this->isColumnModified(ProducerShopTableMap::COL_SHOP_ID)) $criteria->add(ProducerShopTableMap::COL_SHOP_ID, $this->shop_id);
    ...
    {
        $criteria = new Criteria(ProducerShopTableMap::DATABASE_NAME);
        $criteria->add(ProducerShopTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Producer\Model\ORM\ProducerShop (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Producer\Model\ORM\ProducerShop Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProducer(ConnectionInterface $con = null)
    {
        if ($this->aProducer === null && ($this->producer_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProducer->addProducerShops($this);
             */
        }
    ...
    public function getShop(ConnectionInterface $con = null)
    {
        if ($this->aShop === null && ($this->shop_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aShop->addProducerShops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProducerShopTableMap::DEFAULT_STRING_FORMAT);
    }
