...
abstract class ProducerI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Producer\\Model\\ORM\\Map\\ProducerI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Producer\Model\ORM\Base\ProducerI18n object.
     * @see applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProducerI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[ProducerI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ProducerI18nTableMap::COL_NAME] = true;
        }
    ...
    public function setMetaTitle($v)
    {
        ...
        if ($this->meta_title !== $v) {
            $this->meta_title = $v;
            $this->modifiedColumns[ProducerI18nTableMap::COL_META_TITLE] = true;
        }
    ...
    public function setMetaKeyword($v)
    {
        ...
        if ($this->meta_keyword !== $v) {
            $this->meta_keyword = $v;
            $this->modifiedColumns[ProducerI18nTableMap::COL_META_KEYWORD] = true;
        }
    ...
    public function setMetaDescription($v)
    {
        ...
        if ($this->meta_description !== $v) {
            ...
            $this->modifiedColumns[ProducerI18nTableMap::COL_META_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProducerI18nTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProducerI18nTableMap::translateFieldName('MetaTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meta_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProducerI18nTableMap::translateFieldName('MetaKeyword', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meta_keyword = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProducerI18nTableMap::translateFieldName('MetaDescription', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = ProducerI18nTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Producer\Model\ORM\ProducerI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProducerI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ProducerI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'LOCALE';
        }
        if ($this->isColumnModified(ProducerI18nTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'META_TITLE';
        }
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_KEYWORD)) {
            $modifiedColumns[':p' . $index++]  = 'META_KEYWORD';
        }
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProducerI18nTableMap::COL_ID)) $criteria->add(ProducerI18nTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ProducerI18nTableMap::COL_LOCALE)) $criteria->add(ProducerI18nTableMap::COL_LOCALE, $this->locale);
        if ($this->isColumnModified(ProducerI18nTableMap::COL_NAME)) $criteria->add(ProducerI18nTableMap::COL_NAME, $this->name);
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_TITLE)) $criteria->add(ProducerI18nTableMap::COL_META_TITLE, $this->meta_title);
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_KEYWORD)) $criteria->add(ProducerI18nTableMap::COL_META_KEYWORD, $this->meta_keyword);
        if ($this->isColumnModified(ProducerI18nTableMap::COL_META_DESCRIPTION)) $criteria->add(ProducerI18nTableMap::COL_META_DESCRIPTION, $this->meta_description);
    ...
    {
        $criteria = new Criteria(ProducerI18nTableMap::DATABASE_NAME);
        $criteria->add(ProducerI18nTableMap::COL_ID, $this->id);
        $criteria->add(ProducerI18nTableMap::COL_LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Producer\Model\ORM\ProducerI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Producer\Model\ORM\ProducerI18n Clone of current object.
     * @throws PropelException
     */
