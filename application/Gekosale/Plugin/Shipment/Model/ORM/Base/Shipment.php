...
abstract class Shipment implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Shipment\\Model\\ORM\\Map\\ShipmentTableMap';
    ...
    /**
     * The value for the package_number field.
     * @var        string
     */
    protected $package_number;
    ...
    /**
     * The value for the order_data field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Shipment\Model\ORM\Base\Shipment object.
     * @see applyDefaults()
     */
     ...
     *
     * @return Shipment The current object, for fluid interface
     */
    ...
    /**
     * Get the [package_number] column value.
     * 
     * @return   string
     */
    ...
    /**
     * Get the [order_data] column value.
     * 
     * @return   string
     */
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_ORDER_ID] = true;
        }
    ...
    public function setGuid($v)
    {
        ...
        if ($this->guid !== $v) {
            $this->guid = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_GUID] = true;
        }
    ...
    /**
     * Set the value of [package_number] column.
     * 
     * @param      string $v new value
     * @return   \Gekosale\Plugin\Shipment\Model\ORM\Shipment The current object (for fluent API support)
     */
    public function setPackageNumber($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->package_number !== $v) {
            $this->package_number = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_PACKAGE_NUMBER] = true;
        }
    ...
    public function setLabel($v)
    {
        ...
        if (!is_resource($v) && $v !== null) {
            $this->label = fopen('php://memory', 'r+');
            fwrite($this->label, $v);
            rewind($this->label);
        } else { // it's already a stream
            $this->label = $v;
        }
        $this->modifiedColumns[ShipmentTableMap::COL_LABEL] = true;
    ...
    /**
     * Set the value of [order_data] column.
     * 
     * @param      string $v new value
     * @return   \Gekosale\Plugin\Shipment\Model\ORM\Shipment The current object (for fluent API support)
     */
    public function setOrderData($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->order_data !== $v) {
            $this->order_data = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_ORDER_DATA] = true;
        }
    ...
    public function setFormData($v)
    {
        ...
        if ($this->form_data !== $v) {
            $this->form_data = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_FORM_DATA] = true;
        }
    ...
    public function setModel($v)
    {
        ...
        if ($this->model !== $v) {
            $this->model = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_MODEL] = true;
        }
    ...
    public function setEnvelopeId($v)
    {
        ...
        if ($this->envelope_id !== $v) {
            $this->envelope_id = $v;
            $this->modifiedColumns[ShipmentTableMap::COL_ENVELOPE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShipmentTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShipmentTableMap::translateFieldName('Guid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->guid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ShipmentTableMap::translateFieldName('PackageNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->package_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ShipmentTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            if (null !== $col) {
                $this->label = fopen('php://memory', 'r+');
                fwrite($this->label, $col);
                rewind($this->label);
            } else {
                $this->label = null;
            }

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ShipmentTableMap::translateFieldName('OrderData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ShipmentTableMap::translateFieldName('FormData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->form_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ShipmentTableMap::translateFieldName('Model', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = ShipmentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Shipment\Model\ORM\Shipment object", 0, $e);
        }
    }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->isNew() || $this->isModified()) {
                ...
                $affectedRows += 1;
                // Rewind the label LOB column, since PDO does not rewind after inserting value.
                if ($this->label !== null && is_resource($this->label)) {
                    rewind($this->label);
                }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShipmentTableMap::COL_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_ID';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_GUID)) {
            $modifiedColumns[':p' . $index++]  = 'GUID';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_PACKAGE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'PACKAGE_NUMBER';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'LABEL';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_ORDER_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_DATA';
        }
        if ($this->isColumnModified(ShipmentTableMap::COL_FORM_DATA)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'GUID':                        
                        ...
                        break;
                    case 'PACKAGE_NUMBER':                        
                        $stmt->bindValue($identifier, $this->package_number, PDO::PARAM_STR);
                        break;
                    case 'LABEL':                        
                        if (is_resource($this->label)) {
                            rewind($this->label);
                        }
                        $stmt->bindValue($identifier, $this->label, PDO::PARAM_LOB);
                        break;
                    case 'ORDER_DATA':                        
                        $stmt->bindValue($identifier, $this->order_data, PDO::PARAM_STR);
                        break;
                    case 'FORM_DATA':                        
    ...
    {
        if (isset($alreadyDumpedObjects['Shipment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Shipment'][$this->getPrimaryKey()] = true;
        $keys = ShipmentTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrderId(),
            $keys[2] => $this->getGuid(),
            $keys[3] => $this->getPackageNumber(),
            $keys[4] => $this->getLabel(),
            $keys[5] => $this->getOrderData(),
            $keys[6] => $this->getFormData(),
            $keys[7] => $this->getModel(),
            $keys[8] => $this->getIsSent(),
            $keys[9] => $this->getEnvelopeId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setPackageNumber($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setLabel($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setOrderData($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setFormData($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setModel($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setIsSent($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setEnvelopeId($arr[$keys[9]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShipmentTableMap::COL_ID)) $criteria->add(ShipmentTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ShipmentTableMap::COL_ORDER_ID)) $criteria->add(ShipmentTableMap::COL_ORDER_ID, $this->order_id);
        if ($this->isColumnModified(ShipmentTableMap::COL_GUID)) $criteria->add(ShipmentTableMap::COL_GUID, $this->guid);
        if ($this->isColumnModified(ShipmentTableMap::COL_PACKAGE_NUMBER)) $criteria->add(ShipmentTableMap::COL_PACKAGE_NUMBER, $this->package_number);
        if ($this->isColumnModified(ShipmentTableMap::COL_LABEL)) $criteria->add(ShipmentTableMap::COL_LABEL, $this->label);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Shipment\Model\ORM\Shipment (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPackageNumber($this->getPackageNumber());
        $copyObj->setLabel($this->getLabel());
        $copyObj->setOrderData($this->getOrderData());
        $copyObj->setFormData($this->getFormData());
        $copyObj->setModel($this->getModel());
        $copyObj->setIsSent($this->getIsSent());
        $copyObj->setEnvelopeId($this->getEnvelopeId());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Shipment\Model\ORM\Shipment Clone of current object.
     * @throws PropelException
     */
