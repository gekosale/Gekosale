...
abstract class Wishlist implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Wishlist\\Model\\ORM\\Map\\WishlistTableMap';
    ...
    /**
     * The value for the wish_price field.
     * Note: this column has a database default value of: '0.00'
     * @var        string
     */
    protected $wish_price;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->wish_price = '0.00';
    }

    /**
     * Initializes internal state of Gekosale\Plugin\Wishlist\Model\ORM\Base\Wishlist object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [wish_price] column value.
     * 
     * @return   string
     */
     ...
     * @return   \Gekosale\Plugin\Wishlist\Model\ORM\Wishlist The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WishlistTableMap::COL_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[WishlistTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setProductAttributeId($v)
    {
        ...
        if ($this->product_attribute_id !== $v) {
            ...
            $this->modifiedColumns[WishlistTableMap::COL_PRODUCT_ATTRIBUTE_ID] = true;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[WishlistTableMap::COL_CLIENT_ID] = true;
        }
    ...
    /**
     * Set the value of [wish_price] column.
     * 
     * @param      string $v new value
     * @return   \Gekosale\Plugin\Wishlist\Model\ORM\Wishlist The current object (for fluent API support)
     */
    public function setWishPrice($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->wish_price !== $v) {
            $this->wish_price = $v;
            $this->modifiedColumns[WishlistTableMap::COL_WISH_PRICE] = true;
        }
    ...
    public function setShopId($v)
    {
        ...
        if ($this->shop_id !== $v) {
            $this->shop_id = $v;
            $this->modifiedColumns[WishlistTableMap::COL_SHOP_ID] = true;
        }
    ...
    {
            if ($this->product_attribute_id !== 0) {
                return false;
            }

            if ($this->wish_price !== '0.00') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WishlistTableMap::translateFieldName('ProductAttributeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_attribute_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WishlistTableMap::translateFieldName('ClientId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->client_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WishlistTableMap::translateFieldName('WishPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wish_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : WishlistTableMap::translateFieldName('ShopId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = WishlistTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Wishlist\Model\ORM\Wishlist object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PRODUCT_ID';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_PRODUCT_ATTRIBUTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PRODUCT_ATTRIBUTE_ID';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CLIENT_ID';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_WISH_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'WISH_PRICE';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_SHOP_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'CLIENT_ID':                        
                        ...
                        break;
                    case 'WISH_PRICE':                        
                        $stmt->bindValue($identifier, $this->wish_price, PDO::PARAM_STR);
                        break;
                    case 'SHOP_ID':                        
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setWishPrice($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_ID)) $criteria->add(WishlistTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(WishlistTableMap::COL_PRODUCT_ID)) $criteria->add(WishlistTableMap::COL_PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(WishlistTableMap::COL_PRODUCT_ATTRIBUTE_ID)) $criteria->add(WishlistTableMap::COL_PRODUCT_ATTRIBUTE_ID, $this->product_attribute_id);
        if ($this->isColumnModified(WishlistTableMap::COL_CLIENT_ID)) $criteria->add(WishlistTableMap::COL_CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(WishlistTableMap::COL_WISH_PRICE)) $criteria->add(WishlistTableMap::COL_WISH_PRICE, $this->wish_price);
        if ($this->isColumnModified(WishlistTableMap::COL_SHOP_ID)) $criteria->add(WishlistTableMap::COL_SHOP_ID, $this->shop_id);
    ...
    {
        $criteria = new Criteria(WishlistTableMap::DATABASE_NAME);
        $criteria->add(WishlistTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Wishlist\Model\ORM\Wishlist (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setWishPrice($this->getWishPrice());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Wishlist\Model\ORM\Wishlist Clone of current object.
     * @throws PropelException
     */
    ...
    public function getClient(ConnectionInterface $con = null)
    {
        if ($this->aClient === null && ($this->client_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aClient->addWishlists($this);
             */
        }
