...
use Gekosale\Plugin\User\Model\ORM\User;
use Gekosale\Plugin\User\Model\ORM\UserQuery;
...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.User.Model.ORM.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\User\\Model\\ORM\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.User.Model.ORM.User';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\User\\Model\\ORM\\User');
    ...
    {
        $this->addRelation('UserGroupShop', '\\Gekosale\\Plugin\\User\\Model\\ORM\\UserGroupShop', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null, 'UserGroupShops');
        $this->addRelation('UserData', '\\Gekosale\\Plugin\\User\\Model\\ORM\\UserData', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null, 'UserDatas');
        $this->addRelation('UserGroupUser', '\\Gekosale\\Plugin\\User\\Model\\ORM\\UserGroupUser', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null, 'UserGroupUsers');
    } // buildRelations()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\User\Model\ORM\User) { // it's a model object
