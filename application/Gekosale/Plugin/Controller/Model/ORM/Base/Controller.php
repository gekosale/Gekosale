...
abstract class Controller implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Controller\\Model\\ORM\\Map\\ControllerTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Controller\Model\ORM\Base\Controller object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Controller</code> instance.  If
     * <code>obj</code> is an instance of <code>Controller</code>, delegates to
     * <code>equals(Controller)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Controller The current object, for fluid interface
     */
     ...
     * @return   \Gekosale\Plugin\Controller\Model\ORM\Controller The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ControllerTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ControllerTableMap::COL_NAME] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[ControllerTableMap::COL_VERSION] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ControllerTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setEnable($v)
    {
        ...
        if ($this->enable !== $v) {
            $this->enable = $v;
            $this->modifiedColumns[ControllerTableMap::COL_ENABLE] = true;
        }
    ...
    public function setMode($v)
    {
        ...
        if ($this->mode !== $v) {
            $this->mode = $v;
            $this->modifiedColumns[ControllerTableMap::COL_MODE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ControllerTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ControllerTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ControllerTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ControllerTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ControllerTableMap::translateFieldName('Enable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enable = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ControllerTableMap::translateFieldName('Mode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mode = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = ControllerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Controller\Model\ORM\Controller object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildControllerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Controller::setDeleted()
     * @see Controller::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildControllerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ControllerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ControllerTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ControllerTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ControllerTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ControllerTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(ControllerTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION';
        }
        if ($this->isColumnModified(ControllerTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }
        if ($this->isColumnModified(ControllerTableMap::COL_ENABLE)) {
            $modifiedColumns[':p' . $index++]  = 'ENABLE';
        }
        if ($this->isColumnModified(ControllerTableMap::COL_MODE)) {
            $modifiedColumns[':p' . $index++]  = 'MODE';
        }

        $sql = sprintf(
            'INSERT INTO controller (%s) VALUES (%s)',
    ...
    {
        $pos = ControllerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Controller'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Controller'][$this->getPrimaryKey()] = true;
        $keys = ControllerTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setEnable($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setMode($arr[$keys[5]]);
    }
    ...
    {
        $criteria = new Criteria(ControllerTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ControllerTableMap::COL_ID)) $criteria->add(ControllerTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ControllerTableMap::COL_NAME)) $criteria->add(ControllerTableMap::COL_NAME, $this->name);
        if ($this->isColumnModified(ControllerTableMap::COL_VERSION)) $criteria->add(ControllerTableMap::COL_VERSION, $this->version);
        if ($this->isColumnModified(ControllerTableMap::COL_DESCRIPTION)) $criteria->add(ControllerTableMap::COL_DESCRIPTION, $this->description);
        if ($this->isColumnModified(ControllerTableMap::COL_ENABLE)) $criteria->add(ControllerTableMap::COL_ENABLE, $this->enable);
        if ($this->isColumnModified(ControllerTableMap::COL_MODE)) $criteria->add(ControllerTableMap::COL_MODE, $this->mode);
    ...
    {
        $criteria = new Criteria(ControllerTableMap::DATABASE_NAME);
        $criteria->add(ControllerTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Controller\Model\ORM\Controller (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Controller\Model\ORM\Controller Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildController is new, it will return
    ...
    public function getControllerPermissions($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collControllerPermissions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collControllerPermissions) {
                ...
                $collControllerPermissions = ChildControllerPermissionQuery::create(null, $criteria)
                    ->filterByController($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildController The current object (for fluent API support)
     */
    public function setControllerPermissions(Collection $controllerPermissions, ConnectionInterface $con = null)
    {
        ...
        foreach ($controllerPermissionsToDelete as $controllerPermissionRemoved) {
            $controllerPermissionRemoved->setController(null);
        }
    ...
    public function countControllerPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collControllerPermissions || null !== $criteria || $partial) {
            ...
            $query = ChildControllerPermissionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    protected function doAddControllerPermission($controllerPermission)
    {
        ...
        $controllerPermission->setController($this);
    }
    ...
    public function removeControllerPermission($controllerPermission)
    {
        if ($this->getControllerPermissions()->contains($controllerPermission)) {
            ...
            $controllerPermission->setController(null);
        }
     ...
     * Otherwise if this Controller is new, it will return
     * an empty collection; or if this Controller has previously
     * been saved, it will retrieve related ControllerPermissions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Controller.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ControllerTableMap::DEFAULT_STRING_FORMAT);
    }
