...
namespace Gekosale\Plugin\Country\Model\ORM\Map;
...
class CountryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Country.Model.ORM.Map.CountryTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Country\\Model\\ORM\\Country';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Country.Model.ORM.Country';
     ...
     */
    const COL_TRANSLATION = 'country.TRANSLATION';

    /**
     * the column name for the SYMBOL field
     */
    const COL_SYMBOL = 'country.SYMBOL';

    /**
     * the column name for the CURRENCY_ID field
     */
    const COL_CURRENCY_ID = 'country.CURRENCY_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Translation', 'Symbol', 'CurrencyId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'name', 'translation', 'symbol', 'currencyId', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID, CountryTableMap::COL_NAME, CountryTableMap::COL_TRANSLATION, CountryTableMap::COL_SYMBOL, CountryTableMap::COL_CURRENCY_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_NAME', 'COL_TRANSLATION', 'COL_SYMBOL', 'COL_CURRENCY_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'translation', 'symbol', 'currency_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Translation' => 2, 'Symbol' => 3, 'CurrencyId' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'translation' => 2, 'symbol' => 3, 'currencyId' => 4, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID => 0, CountryTableMap::COL_NAME => 1, CountryTableMap::COL_TRANSLATION => 2, CountryTableMap::COL_SYMBOL => 3, CountryTableMap::COL_CURRENCY_ID => 4, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_NAME' => 1, 'COL_TRANSLATION' => 2, 'COL_SYMBOL' => 3, 'COL_CURRENCY_ID' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'translation' => 2, 'symbol' => 3, 'currency_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\Country\\Model\\ORM\\Country');
        $this->setPackage('Gekosale.Plugin.Country.Model.ORM');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('ID', 'Id', 'INTEGER', true, 10, null);
        $this->addColumn('NAME', 'Name', 'VARCHAR', true, 128, null);
        $this->addColumn('TRANSLATION', 'Translation', 'VARCHAR', false, 128, null);
        $this->addColumn('SYMBOL', 'Symbol', 'VARCHAR', false, 45, null);
        $this->addColumn('CURRENCY_ID', 'CurrencyId', 'INTEGER', false, 10, null);
    } // initialize()
    ...
    {
        $this->addRelation('ClientAddress', '\\Gekosale\\Plugin\\Client\\Model\\ORM\\ClientAddress', RelationMap::ONE_TO_MANY, array('id' => 'country_id', ), null, null, 'ClientAddresses');
        $this->addRelation('Company', '\\Gekosale\\Plugin\\Company\\Model\\ORM\\Company', RelationMap::ONE_TO_MANY, array('id' => 'country_id', ), null, null, 'Companies');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountryTableMap::COL_TRANSLATION);
            $criteria->addSelectColumn(CountryTableMap::COL_SYMBOL);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Country\Model\ORM\Country) { // it's a model object
