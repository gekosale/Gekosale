...
use Gekosale\Plugin\Client\Model\ORM\Base\ClientAddress;
...
abstract class Country implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Country\\Model\\ORM\\Map\\CountryTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Country\Model\ORM\Base\Country object.
     */
     ...
     * @return   \Gekosale\Plugin\Country\Model\ORM\Country The current object (for fluent API support)
     */
    ...
    public function setTranslation($v)
    {
        ...
        if ($this->translation !== $v) {
            $this->translation = $v;
            $this->modifiedColumns[CountryTableMap::COL_TRANSLATION] = true;
        }
    ...
    public function setSymbol($v)
    {
        ...
        if ($this->symbol !== $v) {
            $this->symbol = $v;
            $this->modifiedColumns[CountryTableMap::COL_SYMBOL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CountryTableMap::translateFieldName('Translation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->translation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CountryTableMap::translateFieldName('Symbol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->symbol = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CountryTableMap::translateFieldName('CurrencyId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException("Error populating \Gekosale\Plugin\Country\Model\ORM\Country object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->clientAddressesScheduledForDeletion !== null) {
                if (!$this->clientAddressesScheduledForDeletion->isEmpty()) {
                    foreach ($this->clientAddressesScheduledForDeletion as $clientAddress) {
                        // need to save related object because we set the relation to null
                        $clientAddress->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_TRANSLATION)) {
            $modifiedColumns[':p' . $index++]  = 'TRANSLATION';
        }
        if ($this->isColumnModified(CountryTableMap::COL_SYMBOL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_ID)) $criteria->add(CountryTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(CountryTableMap::COL_NAME)) $criteria->add(CountryTableMap::COL_NAME, $this->name);
        if ($this->isColumnModified(CountryTableMap::COL_TRANSLATION)) $criteria->add(CountryTableMap::COL_TRANSLATION, $this->translation);
        if ($this->isColumnModified(CountryTableMap::COL_SYMBOL)) $criteria->add(CountryTableMap::COL_SYMBOL, $this->symbol);
        if ($this->isColumnModified(CountryTableMap::COL_CURRENCY_ID)) $criteria->add(CountryTableMap::COL_CURRENCY_ID, $this->currency_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Country\Model\ORM\Country (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Country\Model\ORM\Country Clone of current object.
     * @throws PropelException
     */
    ...
    public function getClientAddresses($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collClientAddresses || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collClientAddresses) {
                ...
                $collClientAddresses = ClientAddressQuery::create(null, $criteria)
    ...
    public function setClientAddresses(Collection $clientAddresses, ConnectionInterface $con = null)
    {
        ...
        foreach ($clientAddressesToDelete as $clientAddressRemoved) {
            $clientAddressRemoved->setCountry(null);
        }
    ...
    public function removeClientAddress($clientAddress)
    {
        if ($this->getClientAddresses()->contains($clientAddress)) {
            ...
            $this->clientAddressesScheduledForDeletion[]= $clientAddress;
     ...
     * @return Collection|ChildClientAddress[] List of ChildClientAddress objects
     */
    public function getClientAddressesJoinClient($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ClientAddressQuery::create(null, $criteria);
    ...
    public function setCompanies(Collection $companies, ConnectionInterface $con = null)
    {
        ...
        foreach ($companiesToDelete as $companyRemoved) {
            $companyRemoved->setCountry(null);
        }
     ...
     * @return Collection|ChildCompany[] List of ChildCompany objects
     */
    public function getCompaniesJoinFile($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = CompanyQuery::create(null, $criteria);
