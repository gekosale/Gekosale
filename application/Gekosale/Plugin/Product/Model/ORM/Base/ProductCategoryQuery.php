 ...
 * 
 *
 * @method     ChildProductCategoryQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 *
 * @method     ChildProductCategoryQuery groupById() Group by the id column
 ...
 *
 * @method     ChildProductCategory findOneById(int $id) Return the first ChildProductCategory filtered by the id column
 ...
 *
 * @method     array findById(int $id) Return ChildProductCategory objects filtered by the id column
...
abstract class ProductCategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Product\Model\ORM\Base\ProductCategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Product\\Model\\ORM\\ProductCategory', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\Product\Model\ORM\ProductCategoryQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Product\Model\ORM\ProductCategoryQuery();
        if (null !== $modelAlias) {
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = ProductCategoryTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT ID, PRODUCT_ID, CATEGORY_ID FROM product_category WHERE ID = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ProductCategoryTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $id, $comparison);
    }
    ...
    {
        if ($productCategory) {
            $this->addUsingAlias(ProductCategoryTableMap::COL_ID, $productCategory->getId(), Criteria::NOT_EQUAL);
        }
