...
abstract class ProductPhoto implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Product\\Model\\ORM\\Map\\ProductPhotoTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Product\Model\ORM\Base\ProductPhoto object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ProductPhoto</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductPhoto</code>, delegates to
     * <code>equals(ProductPhoto)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProductPhoto The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProductPhotoTableMap::COL_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[ProductPhotoTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setPhotoId($v)
    {
        ...
        if ($this->photo_id !== $v) {
            $this->photo_id = $v;
            $this->modifiedColumns[ProductPhotoTableMap::COL_PHOTO_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductPhotoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductPhotoTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductPhotoTableMap::translateFieldName('PhotoId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ProductPhotoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Product\Model\ORM\ProductPhoto object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductPhotoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProductPhoto::setDeleted()
     * @see ProductPhoto::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProductPhotoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductPhotoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductPhotoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ProductPhotoTableMap::COL_PRODUCT_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO product_photo (%s) VALUES (%s)',
    ...
    {
        $pos = ProductPhotoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $keys = ProductPhotoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(ProductPhotoTableMap::DATABASE_NAME);
        $criteria->add(ProductPhotoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Product\Model\ORM\ProductPhoto (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Product\Model\ORM\ProductPhoto Clone of current object.
     * @throws PropelException
     */
    ...
    public function getFile(ConnectionInterface $con = null)
    {
        if ($this->aFile === null && ($this->photo_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFile->addProductPhotos($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductPhotoTableMap::DEFAULT_STRING_FORMAT);
    }
