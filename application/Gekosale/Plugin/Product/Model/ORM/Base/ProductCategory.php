...
abstract class ProductCategory implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Product\\Model\\ORM\\Map\\ProductCategoryTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Product\Model\ORM\Base\ProductCategory object.
     */
     ...
     * @return   \Gekosale\Plugin\Product\Model\ORM\ProductCategory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProductCategoryTableMap::COL_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[ProductCategoryTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductCategoryTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductCategoryTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductCategoryTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProductCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Product\Model\ORM\ProductCategory object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductCategoryTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ProductCategoryTableMap::COL_PRODUCT_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductCategoryTableMap::COL_ID)) $criteria->add(ProductCategoryTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ProductCategoryTableMap::COL_PRODUCT_ID)) $criteria->add(ProductCategoryTableMap::COL_PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(ProductCategoryTableMap::COL_CATEGORY_ID)) $criteria->add(ProductCategoryTableMap::COL_CATEGORY_ID, $this->category_id);
    ...
    {
        $criteria = new Criteria(ProductCategoryTableMap::DATABASE_NAME);
        $criteria->add(ProductCategoryTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Product\Model\ORM\ProductCategory (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Product\Model\ORM\ProductCategory Clone of current object.
     * @throws PropelException
     */
