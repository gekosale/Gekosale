...
class ProductCategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Product.Model.ORM.Map.ProductCategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Product\\Model\\ORM\\ProductCategory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Product.Model.ORM.ProductCategory';
     ...
     */
    const COL_ID = 'product_category.ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ProductId', 'CategoryId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'productId', 'categoryId', ),
        self::TYPE_COLNAME       => array(ProductCategoryTableMap::COL_ID, ProductCategoryTableMap::COL_PRODUCT_ID, ProductCategoryTableMap::COL_CATEGORY_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_PRODUCT_ID', 'COL_CATEGORY_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'product_id', 'category_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ProductId' => 1, 'CategoryId' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'productId' => 1, 'categoryId' => 2, ),
        self::TYPE_COLNAME       => array(ProductCategoryTableMap::COL_ID => 0, ProductCategoryTableMap::COL_PRODUCT_ID => 1, ProductCategoryTableMap::COL_CATEGORY_ID => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_PRODUCT_ID' => 1, 'COL_CATEGORY_ID' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'product_id' => 1, 'category_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\Product\\Model\\ORM\\ProductCategory');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Product\Model\ORM\ProductCategory) { // it's a model object
