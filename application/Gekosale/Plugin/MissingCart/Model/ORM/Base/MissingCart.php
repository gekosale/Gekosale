...
abstract class MissingCart implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\MissingCart\\Model\\ORM\\Map\\MissingCartTableMap';
    ...
    /**
     * The value for the client_mail field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\MissingCart\Model\ORM\Base\MissingCart object.
     */
    ...
    /**
     * Compares this with another <code>MissingCart</code> instance.  If
     * <code>obj</code> is an instance of <code>MissingCart</code>, delegates to
     * <code>equals(MissingCart)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return MissingCart The current object, for fluid interface
     */
    ...
    /**
     * Get the [client_mail] column value.
     * 
     * @return   string
     */
     ...
     * @return   \Gekosale\Plugin\MissingCart\Model\ORM\MissingCart The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MissingCartTableMap::COL_ID] = true;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[MissingCartTableMap::COL_CLIENT_ID] = true;
        }
    ...
    /**
     * Set the value of [client_mail] column.
     * 
     * @param      string $v new value
     * @return   \Gekosale\Plugin\MissingCart\Model\ORM\MissingCart The current object (for fluent API support)
     */
    public function setClientMail($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->client_mail !== $v) {
            $this->client_mail = $v;
            $this->modifiedColumns[MissingCartTableMap::COL_CLIENT_MAIL] = true;
        }
    ...
    public function setSessionId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[MissingCartTableMap::COL_SESSION_ID] = true;
        }
    ...
    public function setShopId($v)
    {
        ...
        if ($this->shop_id !== $v) {
            $this->shop_id = $v;
            $this->modifiedColumns[MissingCartTableMap::COL_SHOP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MissingCartTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MissingCartTableMap::translateFieldName('ClientId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->client_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MissingCartTableMap::translateFieldName('ClientMail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->client_mail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MissingCartTableMap::translateFieldName('SessionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->session_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MissingCartTableMap::translateFieldName('ShopId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = MissingCartTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\MissingCart\Model\ORM\MissingCart object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMissingCartQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MissingCart::setDeleted()
     * @see MissingCart::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildMissingCartQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MissingCartTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MissingCartTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(MissingCartTableMap::COL_CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CLIENT_ID';
        }
        if ($this->isColumnModified(MissingCartTableMap::COL_CLIENT_MAIL)) {
            $modifiedColumns[':p' . $index++]  = 'CLIENT_MAIL';
        }
        if ($this->isColumnModified(MissingCartTableMap::COL_SESSION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SESSION_ID';
        }
        if ($this->isColumnModified(MissingCartTableMap::COL_SHOP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SHOP_ID';
        }

        $sql = sprintf(
            'INSERT INTO missing_cart (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'CLIENT_ID':                        
                        ...
                        break;
                    case 'CLIENT_MAIL':                        
                        $stmt->bindValue($identifier, $this->client_mail, PDO::PARAM_STR);
                        break;
                    case 'SESSION_ID':                        
    ...
    {
        $pos = MissingCartTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MissingCart'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MissingCart'][$this->getPrimaryKey()] = true;
        $keys = MissingCartTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getClientId(),
            $keys[2] => $this->getClientMail(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setClientMail($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MissingCartTableMap::COL_ID)) $criteria->add(MissingCartTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(MissingCartTableMap::COL_CLIENT_ID)) $criteria->add(MissingCartTableMap::COL_CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(MissingCartTableMap::COL_CLIENT_MAIL)) $criteria->add(MissingCartTableMap::COL_CLIENT_MAIL, $this->client_mail);
        if ($this->isColumnModified(MissingCartTableMap::COL_SESSION_ID)) $criteria->add(MissingCartTableMap::COL_SESSION_ID, $this->session_id);
        if ($this->isColumnModified(MissingCartTableMap::COL_SHOP_ID)) $criteria->add(MissingCartTableMap::COL_SHOP_ID, $this->shop_id);
    ...
    {
        $criteria = new Criteria(MissingCartTableMap::DATABASE_NAME);
        $criteria->add(MissingCartTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\MissingCart\Model\ORM\MissingCart (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setClientMail($this->getClientMail());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\MissingCart\Model\ORM\MissingCart Clone of current object.
     * @throws PropelException
     */
    ...
    public function getClient(ConnectionInterface $con = null)
    {
        if ($this->aClient === null && ($this->client_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aClient->addMissingCarts($this);
             */
        }
    ...
    public function getShop(ConnectionInterface $con = null)
    {
        if ($this->aShop === null && ($this->shop_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aShop->addMissingCarts($this);
             */
        }
     ...
     * If this ChildMissingCart is new, it will return
    ...
    public function getMissingCartProducts($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collMissingCartProducts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collMissingCartProducts) {
                ...
                $collMissingCartProducts = ChildMissingCartProductQuery::create(null, $criteria)
                    ->filterByMissingCart($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildMissingCart The current object (for fluent API support)
     */
    public function setMissingCartProducts(Collection $missingCartProducts, ConnectionInterface $con = null)
    {
        ...
        foreach ($missingCartProductsToDelete as $missingCartProductRemoved) {
            $missingCartProductRemoved->setMissingCart(null);
        }
    ...
    public function countMissingCartProducts(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collMissingCartProducts || null !== $criteria || $partial) {
            ...
            $query = ChildMissingCartProductQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    protected function doAddMissingCartProduct($missingCartProduct)
    {
        ...
        $missingCartProduct->setMissingCart($this);
    }
    ...
    public function removeMissingCartProduct($missingCartProduct)
    {
        if ($this->getMissingCartProducts()->contains($missingCartProduct)) {
            ...
            $missingCartProduct->setMissingCart(null);
        }
     ...
     * Otherwise if this MissingCart is new, it will return
     * an empty collection; or if this MissingCart has previously
     * been saved, it will retrieve related MissingCartProducts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MissingCart.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(MissingCartTableMap::DEFAULT_STRING_FORMAT);
    }
