...
abstract class Newsletter implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Newsletter\\Model\\ORM\\Map\\NewsletterTableMap';
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[NewsletterTableMap::COL_EMAIL] = true;
        }
    ...
    public function setRecipients($v)
    {
        ...
        if ($this->recipients !== $v) {
            $this->recipients = $v;
            $this->modifiedColumns[NewsletterTableMap::COL_RECIPIENTS] = true;
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Newsletter\Model\ORM\Newsletter (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Newsletter\Model\ORM\Newsletter Clone of current object.
     * @throws PropelException
     */
