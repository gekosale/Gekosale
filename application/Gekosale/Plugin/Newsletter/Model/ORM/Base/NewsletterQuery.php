 ...
 *
 * @method     ChildNewsletterQuery leftJoinNewsletterI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the NewsletterI18n relation
 * @method     ChildNewsletterQuery rightJoinNewsletterI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the NewsletterI18n relation
 * @method     ChildNewsletterQuery innerJoinNewsletterI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the NewsletterI18n relation
 *
...
abstract class NewsletterQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, EMAIL, RECIPIENTS, CREATED_AT, UPDATED_AT FROM newsletter WHERE ID = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(NewsletterTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(NewsletterTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NewsletterTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(NewsletterTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(NewsletterTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NewsletterTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }

    /**
     * Filter the query by a related \Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18n object
     *
     * @param \Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18n|ObjectCollection $newsletterI18n  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildNewsletterQuery The current query, for fluid interface
     */
    public function filterByNewsletterI18n($newsletterI18n, $comparison = null)
    {
        if ($newsletterI18n instanceof \Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18n) {
            return $this
                ->addUsingAlias(NewsletterTableMap::COL_ID, $newsletterI18n->getId(), $comparison);
        } elseif ($newsletterI18n instanceof ObjectCollection) {
            return $this
                ->useNewsletterI18nQuery()
                ->filterByPrimaryKeys($newsletterI18n->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByNewsletterI18n() only accepts arguments of type \Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18n or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the NewsletterI18n relation
     *
     ...
     * @return ChildNewsletterQuery The current query, for fluid interface
     */
    public function joinNewsletterI18n($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('NewsletterI18n');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'NewsletterI18n');
        }
    ...
    /**
     * Use the NewsletterI18n relation NewsletterI18n object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18nQuery A secondary query class using the current class as primary query
     */
    public function useNewsletterI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinNewsletterI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'NewsletterI18n', '\Gekosale\Plugin\Newsletter\Model\ORM\NewsletterI18nQuery');
    }
    ...
    {
        $relationName = $relationAlias ? $relationAlias : 'NewsletterI18n';
    ...
    public function joinWithI18n($locale = 'en_US', $joinType = Criteria::LEFT_JOIN)
    {
        $this
            ...
            ->with('NewsletterI18n');
        $this->with['NewsletterI18n']->setIsWithOneToMany(false);
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'. Defaults to left join.
     *
     * @return    ChildNewsletterI18nQuery A secondary query class using the current class as primary query
     */
    ...
    {
        return $this->addUsingAlias(NewsletterTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addUsingAlias(NewsletterTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(NewsletterTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(NewsletterTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(NewsletterTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(NewsletterTableMap::COL_CREATED_AT);
    }
