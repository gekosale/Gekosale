...
abstract class AvailabilityI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Availability\\Model\\ORM\\Map\\AvailabilityI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Availability\Model\ORM\Base\AvailabilityI18n object.
     * @see applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AvailabilityI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[AvailabilityI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AvailabilityI18nTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'LOCALE';
        }
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_ID)) $criteria->add(AvailabilityI18nTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_LOCALE)) $criteria->add(AvailabilityI18nTableMap::COL_LOCALE, $this->locale);
        if ($this->isColumnModified(AvailabilityI18nTableMap::COL_NAME)) $criteria->add(AvailabilityI18nTableMap::COL_NAME, $this->name);
    ...
    {
        $criteria = new Criteria(AvailabilityI18nTableMap::DATABASE_NAME);
        $criteria->add(AvailabilityI18nTableMap::COL_ID, $this->id);
        $criteria->add(AvailabilityI18nTableMap::COL_LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n Clone of current object.
     * @throws PropelException
     */
