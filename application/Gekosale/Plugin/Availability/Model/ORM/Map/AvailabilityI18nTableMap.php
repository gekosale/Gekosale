...
use Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n;
use Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18nQuery;
...
class AvailabilityI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Availability.Model.ORM.Map.AvailabilityI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Availability\\Model\\ORM\\AvailabilityI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Availability.Model.ORM.AvailabilityI18n';
     ...
     */
    const COL_ID = 'availability_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const COL_LOCALE = 'availability_i18n.LOCALE';

    /**
     * the column name for the NAME field
     */
    const COL_NAME = 'availability_i18n.NAME';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AvailabilityI18nTableMap::COL_ID, AvailabilityI18nTableMap::COL_LOCALE, AvailabilityI18nTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AvailabilityI18nTableMap::COL_ID => 0, AvailabilityI18nTableMap::COL_LOCALE => 1, AvailabilityI18nTableMap::COL_NAME => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Plugin\\Availability\\Model\\ORM\\AvailabilityI18n');
    ...
    {
        $this->addRelation('Availability', '\\Gekosale\\Plugin\\Availability\\Model\\ORM\\Availability', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n $obj A \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n object.
     ...
     *
     * @param mixed $value A \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AvailabilityI18nTableMap::COL_ID);
            $criteria->addSelectColumn(AvailabilityI18nTableMap::COL_LOCALE);
            $criteria->addSelectColumn(AvailabilityI18nTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Availability\Model\ORM\AvailabilityI18n) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(AvailabilityI18nTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(AvailabilityI18nTableMap::COL_LOCALE, $value[1]));
