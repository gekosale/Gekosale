 ...
 * @method     ChildDispatchMethodQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildDispatchMethodQuery orderByDescription($order = Criteria::ASC) Order by the description column
 ...
 * @method     ChildDispatchMethodQuery groupByName() Group by the name column
 * @method     ChildDispatchMethodQuery groupByDescription() Group by the description column
 ...
 * @method     ChildDispatchMethod findOneByName(string $name) Return the first ChildDispatchMethod filtered by the name column
 * @method     ChildDispatchMethod findOneByDescription(string $description) Return the first ChildDispatchMethod filtered by the description column
 ...
 * @method     array findByName(string $name) Return ChildDispatchMethod objects filtered by the name column
 * @method     array findByDescription(string $description) Return ChildDispatchMethod objects filtered by the description column
...
abstract class DispatchMethodQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, NAME, DESCRIPTION, TYPE, MAXIMUM_WEIGHT, FREE_DELIVERY, COUNTRY_IDS, CURRENCY_ID, HIERARCHY FROM dispatch_method WHERE ID = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DispatchMethodTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DispatchMethodTableMap::COL_DESCRIPTION, $description, $comparison);
    }
