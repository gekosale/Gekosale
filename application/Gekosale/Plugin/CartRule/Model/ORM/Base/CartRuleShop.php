...
abstract class CartRuleShop implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\CartRule\\Model\\ORM\\Map\\CartRuleShopTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\CartRule\Model\ORM\Base\CartRuleShop object.
     */
    ...
    /**
     * Compares this with another <code>CartRuleShop</code> instance.  If
     * <code>obj</code> is an instance of <code>CartRuleShop</code>, delegates to
     * <code>equals(CartRuleShop)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CartRuleShop The current object, for fluid interface
     */
     ...
     * @return   \Gekosale\Plugin\CartRule\Model\ORM\CartRuleShop The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CartRuleShopTableMap::COL_ID] = true;
        }
    ...
    public function setCartRuleId($v)
    {
        ...
        if ($this->cart_rule_id !== $v) {
            $this->cart_rule_id = $v;
            $this->modifiedColumns[CartRuleShopTableMap::COL_CART_RULE_ID] = true;
        }
    ...
    public function setShopId($v)
    {
        ...
        if ($this->shop_id !== $v) {
            $this->shop_id = $v;
            $this->modifiedColumns[CartRuleShopTableMap::COL_SHOP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CartRuleShopTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartRuleShopTableMap::translateFieldName('CartRuleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cart_rule_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartRuleShopTableMap::translateFieldName('ShopId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CartRuleShopTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\CartRule\Model\ORM\CartRuleShop object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCartRuleShopQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CartRuleShop::setDeleted()
     * @see CartRuleShop::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCartRuleShopQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CartRuleShopTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CartRuleShopTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(CartRuleShopTableMap::COL_CART_RULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CART_RULE_ID';
        }
        if ($this->isColumnModified(CartRuleShopTableMap::COL_SHOP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SHOP_ID';
        }

        $sql = sprintf(
            'INSERT INTO cart_rule_shop (%s) VALUES (%s)',
    ...
    {
        $pos = CartRuleShopTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CartRuleShop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CartRuleShop'][$this->getPrimaryKey()] = true;
        $keys = CartRuleShopTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CartRuleShopTableMap::COL_ID)) $criteria->add(CartRuleShopTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(CartRuleShopTableMap::COL_CART_RULE_ID)) $criteria->add(CartRuleShopTableMap::COL_CART_RULE_ID, $this->cart_rule_id);
        if ($this->isColumnModified(CartRuleShopTableMap::COL_SHOP_ID)) $criteria->add(CartRuleShopTableMap::COL_SHOP_ID, $this->shop_id);
    ...
    {
        $criteria = new Criteria(CartRuleShopTableMap::DATABASE_NAME);
        $criteria->add(CartRuleShopTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\CartRule\Model\ORM\CartRuleShop (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\CartRule\Model\ORM\CartRuleShop Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCartRule(ConnectionInterface $con = null)
    {
        if ($this->aCartRule === null && ($this->cart_rule_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCartRule->addCartRuleShops($this);
             */
        }
    ...
    public function getShop(ConnectionInterface $con = null)
    {
        if ($this->aShop === null && ($this->shop_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aShop->addCartRuleShops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CartRuleShopTableMap::DEFAULT_STRING_FORMAT);
    }
