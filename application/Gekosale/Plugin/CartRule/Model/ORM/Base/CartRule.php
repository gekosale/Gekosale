...
use Gekosale\Plugin\CartRule\Model\ORM\CartRuleShopQuery as ChildCartRuleShopQuery;
...
abstract class CartRule implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\CartRule\\Model\\ORM\\Map\\CartRuleTableMap';
    ...
    /**
     * The value for the discount_for_all field.
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $discount_for_all;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->discount_for_all = 0;
    }

    /**
     * Initializes internal state of Gekosale\Plugin\CartRule\Model\ORM\Base\CartRule object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CartRule</code> instance.  If
     * <code>obj</code> is an instance of <code>CartRule</code>, delegates to
     * <code>equals(CartRule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CartRule The current object, for fluid interface
     */
    ...
    public function getDateFrom($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->date_from instanceof \DateTime ? $this->date_from->format($format) : null;
        }
    }
    ...
    public function getDateTo($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->date_to instanceof \DateTime ? $this->date_to->format($format) : null;
        }
    }

    /**
     * Get the [discount_for_all] column value.
     * 
     * @return   int
     */
    public function getDiscountForAll()
    {
     ...
     * @return   \Gekosale\Plugin\CartRule\Model\ORM\CartRule The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CartRuleTableMap::COL_ID] = true;
        }
    ...
    public function setHierarchy($v)
    {
        ...
        if ($this->hierarchy !== $v) {
            $this->hierarchy = $v;
            $this->modifiedColumns[CartRuleTableMap::COL_HIERARCHY] = true;
        }
    ...
    public function setSuffixTypeId($v)
    {
        ...
        if ($this->suffix_type_id !== $v) {
            ...
            $this->modifiedColumns[CartRuleTableMap::COL_SUFFIX_TYPE_ID] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[CartRuleTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function setFreeShipping($v)
    {
        ...
        if ($this->free_shipping !== $v) {
            ...
            $this->modifiedColumns[CartRuleTableMap::COL_FREE_SHIPPING] = true;
        }
    ...
    public function setDateFrom($v)
    {
        ...
        if ($this->date_from !== null || $dt !== null) {
            if ($dt !== $this->date_from) {
                $this->date_from = $dt;
                $this->modifiedColumns[CartRuleTableMap::COL_DATE_FROM] = true;
            }
    ...
    public function setDateTo($v)
    {
        ...
        if ($this->date_to !== null || $dt !== null) {
            if ($dt !== $this->date_to) {
                $this->date_to = $dt;
                $this->modifiedColumns[CartRuleTableMap::COL_DATE_TO] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [discount_for_all] column.
     * 
     * @param      int $v new value
     * @return   \Gekosale\Plugin\CartRule\Model\ORM\CartRule The current object (for fluent API support)
     */
    public function setDiscountForAll($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->discount_for_all !== $v) {
            $this->discount_for_all = $v;
            $this->modifiedColumns[CartRuleTableMap::COL_DISCOUNT_FOR_ALL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CartRuleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartRuleTableMap::translateFieldName('Hierarchy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hierarchy = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartRuleTableMap::translateFieldName('SuffixTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->suffix_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CartRuleTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CartRuleTableMap::translateFieldName('FreeShipping', TableMap::TYPE_PHPNAME, $indexType)];
            $this->free_shipping = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CartRuleTableMap::translateFieldName('DateFrom', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_from = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CartRuleTableMap::translateFieldName('DateTo', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_to = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CartRuleTableMap::translateFieldName('DiscountForAll', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_for_all = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = CartRuleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\CartRule\Model\ORM\CartRule object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCartRuleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CartRule::setDeleted()
     * @see CartRule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCartRuleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CartRuleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CartRuleTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_HIERARCHY)) {
            $modifiedColumns[':p' . $index++]  = 'HIERARCHY';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_SUFFIX_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SUFFIX_TYPE_ID';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'DISCOUNT';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_FREE_SHIPPING)) {
            $modifiedColumns[':p' . $index++]  = 'FREE_SHIPPING';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_DATE_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'DATE_FROM';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_DATE_TO)) {
            $modifiedColumns[':p' . $index++]  = 'DATE_TO';
        }
        if ($this->isColumnModified(CartRuleTableMap::COL_DISCOUNT_FOR_ALL)) {
            $modifiedColumns[':p' . $index++]  = 'DISCOUNT_FOR_ALL';
        }

        $sql = sprintf(
            'INSERT INTO cart_rule (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'FREE_SHIPPING':                        
                        ...
                        break;
                    case 'DATE_FROM':                        
                        $stmt->bindValue($identifier, $this->date_from ? $this->date_from->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'DATE_TO':                        
                        $stmt->bindValue($identifier, $this->date_to ? $this->date_to->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'DISCOUNT_FOR_ALL':                        
                        $stmt->bindValue($identifier, $this->discount_for_all, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = CartRuleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CartRule'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CartRule'][$this->getPrimaryKey()] = true;
        $keys = CartRuleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getHierarchy(),
            $keys[2] => $this->getSuffixTypeId(),
            $keys[3] => $this->getDiscount(),
            $keys[4] => $this->getFreeShipping(),
            $keys[5] => $this->getDateFrom(),
            $keys[6] => $this->getDateTo(),
            $keys[7] => $this->getDiscountForAll(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setHierarchy($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setSuffixTypeId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setDiscount($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setFreeShipping($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setDateFrom($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setDateTo($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setDiscountForAll($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CartRuleTableMap::COL_ID)) $criteria->add(CartRuleTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(CartRuleTableMap::COL_HIERARCHY)) $criteria->add(CartRuleTableMap::COL_HIERARCHY, $this->hierarchy);
        if ($this->isColumnModified(CartRuleTableMap::COL_SUFFIX_TYPE_ID)) $criteria->add(CartRuleTableMap::COL_SUFFIX_TYPE_ID, $this->suffix_type_id);
        if ($this->isColumnModified(CartRuleTableMap::COL_DISCOUNT)) $criteria->add(CartRuleTableMap::COL_DISCOUNT, $this->discount);
        if ($this->isColumnModified(CartRuleTableMap::COL_FREE_SHIPPING)) $criteria->add(CartRuleTableMap::COL_FREE_SHIPPING, $this->free_shipping);
        if ($this->isColumnModified(CartRuleTableMap::COL_DATE_FROM)) $criteria->add(CartRuleTableMap::COL_DATE_FROM, $this->date_from);
        if ($this->isColumnModified(CartRuleTableMap::COL_DATE_TO)) $criteria->add(CartRuleTableMap::COL_DATE_TO, $this->date_to);
        if ($this->isColumnModified(CartRuleTableMap::COL_DISCOUNT_FOR_ALL)) $criteria->add(CartRuleTableMap::COL_DISCOUNT_FOR_ALL, $this->discount_for_all);
    ...
    {
        $criteria = new Criteria(CartRuleTableMap::DATABASE_NAME);
        $criteria->add(CartRuleTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\CartRule\Model\ORM\CartRule (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDiscountForAll($this->getDiscountForAll());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\CartRule\Model\ORM\CartRule Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSuffixType(ConnectionInterface $con = null)
    {
        if ($this->aSuffixType === null && ($this->suffix_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSuffixType->addCartRules($this);
             */
        }
     ...
     * If this ChildCartRule is new, it will return
    ...
    public function getCartRuleClientGroups($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCartRuleClientGroups || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCartRuleClientGroups) {
                ...
                $collCartRuleClientGroups = ChildCartRuleClientGroupQuery::create(null, $criteria)
                    ->filterByCartRule($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildCartRule The current object (for fluent API support)
     */
    public function setCartRuleClientGroups(Collection $cartRuleClientGroups, ConnectionInterface $con = null)
    {
        ...
        foreach ($cartRuleClientGroupsToDelete as $cartRuleClientGroupRemoved) {
            $cartRuleClientGroupRemoved->setCartRule(null);
        }
    ...
    public function countCartRuleClientGroups(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCartRuleClientGroups || null !== $criteria || $partial) {
            ...
            $query = ChildCartRuleClientGroupQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    protected function doAddCartRuleClientGroup($cartRuleClientGroup)
    {
        ...
        $cartRuleClientGroup->setCartRule($this);
    }
    ...
    public function removeCartRuleClientGroup($cartRuleClientGroup)
    {
        if ($this->getCartRuleClientGroups()->contains($cartRuleClientGroup)) {
            ...
            $cartRuleClientGroup->setCartRule(null);
        }
     ...
     * Otherwise if this CartRule is new, it will return
     * an empty collection; or if this CartRule has previously
     * been saved, it will retrieve related CartRuleClientGroups from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CartRule.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return Collection|ChildCartRuleClientGroup[] List of ChildCartRuleClientGroup objects
     */
    public function getCartRuleClientGroupsJoinClientGroup($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCartRuleClientGroupQuery::create(null, $criteria);
    ...
    public function setCartRuleRules(Collection $cartRuleRules, ConnectionInterface $con = null)
    {
        ...
        foreach ($cartRuleRulesToDelete as $cartRuleRuleRemoved) {
            $cartRuleRuleRemoved->setCartRule(null);
        }
     ...
     * @return Collection|ChildCartRuleRule[] List of ChildCartRuleRule objects
     */
    public function getCartRuleRulesJoinRule($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCartRuleRuleQuery::create(null, $criteria);
        $query->joinWith('Rule', $joinBehavior);
    ...
    public function getCartRuleShops($criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCartRuleShops || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCartRuleShops) {
                ...
                $collCartRuleShops = ChildCartRuleShopQuery::create(null, $criteria)
                    ->filterByCartRule($this)
                    ->find($con);
    ...
    public function setCartRuleShops(Collection $cartRuleShops, ConnectionInterface $con = null)
    {
        ...
        foreach ($cartRuleShopsToDelete as $cartRuleShopRemoved) {
            $cartRuleShopRemoved->setCartRule(null);
        }
    ...
    public function countCartRuleShops(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collCartRuleShops || null !== $criteria || $partial) {
            ...
            $query = ChildCartRuleShopQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
     ...
     * @return Collection|ChildCartRuleShop[] List of ChildCartRuleShop objects
     */
    public function getCartRuleShopsJoinShop($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCartRuleShopQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CartRuleTableMap::DEFAULT_STRING_FORMAT);
    }
