...
abstract class ContactShop implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Contact\\Model\\ORM\\Map\\ContactShopTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Contact\Model\ORM\Base\ContactShop object.
     */
    ...
    /**
     * Compares this with another <code>ContactShop</code> instance.  If
     * <code>obj</code> is an instance of <code>ContactShop</code>, delegates to
     * <code>equals(ContactShop)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ContactShop The current object, for fluid interface
     */
     ...
     * @return   \Gekosale\Plugin\Contact\Model\ORM\ContactShop The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ContactShopTableMap::COL_ID] = true;
        }
    ...
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[ContactShopTableMap::COL_CONTACT_ID] = true;
        }
    ...
    public function setShopId($v)
    {
        ...
        if ($this->shop_id !== $v) {
            $this->shop_id = $v;
            $this->modifiedColumns[ContactShopTableMap::COL_SHOP_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContactShopTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContactShopTableMap::translateFieldName('ContactId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContactShopTableMap::translateFieldName('ShopId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ContactShopTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Contact\Model\ORM\ContactShop object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildContactShopQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ContactShop::setDeleted()
     * @see ContactShop::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildContactShopQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContactShopTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContactShopTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ContactShopTableMap::COL_CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CONTACT_ID';
        }
        if ($this->isColumnModified(ContactShopTableMap::COL_SHOP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SHOP_ID';
        }

        $sql = sprintf(
            'INSERT INTO contact_shop (%s) VALUES (%s)',
    ...
    {
        $pos = ContactShopTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ContactShop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ContactShop'][$this->getPrimaryKey()] = true;
        $keys = ContactShopTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContactShopTableMap::COL_ID)) $criteria->add(ContactShopTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(ContactShopTableMap::COL_CONTACT_ID)) $criteria->add(ContactShopTableMap::COL_CONTACT_ID, $this->contact_id);
        if ($this->isColumnModified(ContactShopTableMap::COL_SHOP_ID)) $criteria->add(ContactShopTableMap::COL_SHOP_ID, $this->shop_id);
    ...
    {
        $criteria = new Criteria(ContactShopTableMap::DATABASE_NAME);
        $criteria->add(ContactShopTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Contact\Model\ORM\ContactShop (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Contact\Model\ORM\ContactShop Clone of current object.
     * @throws PropelException
     */
    ...
    public function getContact(ConnectionInterface $con = null)
    {
        if ($this->aContact === null && ($this->contact_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContact->addContactShops($this);
             */
        }
    ...
    public function getShop(ConnectionInterface $con = null)
    {
        if ($this->aShop === null && ($this->shop_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aShop->addContactShops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ContactShopTableMap::DEFAULT_STRING_FORMAT);
    }
