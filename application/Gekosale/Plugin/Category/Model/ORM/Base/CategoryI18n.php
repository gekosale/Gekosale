...
use Gekosale\Plugin\Category\Model\ORM\Map\CategoryI18nTableMap;
...
abstract class CategoryI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Plugin\\Category\\Model\\ORM\\Map\\CategoryI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Plugin\Category\Model\ORM\Base\CategoryI18n object.
     * @see applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_NAME] = true;
        }
    ...
    public function setShortDescription($v)
    {
        ...
        if ($this->short_description !== $v) {
            ...
            $this->modifiedColumns[CategoryI18nTableMap::COL_SHORT_DESCRIPTION] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setMetaTitle($v)
    {
        ...
        if ($this->meta_title !== $v) {
            $this->meta_title = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_META_TITLE] = true;
        }
    ...
    public function setMetaKeyword($v)
    {
        ...
        if ($this->meta_keyword !== $v) {
            $this->meta_keyword = $v;
            $this->modifiedColumns[CategoryI18nTableMap::COL_META_KEYWORD] = true;
        }
    ...
    public function setMetaDescription($v)
    {
        ...
        if ($this->meta_description !== $v) {
            ...
            $this->modifiedColumns[CategoryI18nTableMap::COL_META_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryI18nTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoryI18nTableMap::translateFieldName('ShortDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->short_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoryI18nTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategoryI18nTableMap::translateFieldName('MetaTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meta_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategoryI18nTableMap::translateFieldName('MetaKeyword', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = CategoryI18nTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Gekosale\Plugin\Category\Model\ORM\CategoryI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryI18nTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'LOCALE';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_SHORT_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'SHORT_DESCRIPTION';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'META_TITLE';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_KEYWORD)) {
            $modifiedColumns[':p' . $index++]  = 'META_KEYWORD';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryI18nTableMap::COL_ID)) $criteria->add(CategoryI18nTableMap::COL_ID, $this->id);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_LOCALE)) $criteria->add(CategoryI18nTableMap::COL_LOCALE, $this->locale);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_NAME)) $criteria->add(CategoryI18nTableMap::COL_NAME, $this->name);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_SHORT_DESCRIPTION)) $criteria->add(CategoryI18nTableMap::COL_SHORT_DESCRIPTION, $this->short_description);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_DESCRIPTION)) $criteria->add(CategoryI18nTableMap::COL_DESCRIPTION, $this->description);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_TITLE)) $criteria->add(CategoryI18nTableMap::COL_META_TITLE, $this->meta_title);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_KEYWORD)) $criteria->add(CategoryI18nTableMap::COL_META_KEYWORD, $this->meta_keyword);
        if ($this->isColumnModified(CategoryI18nTableMap::COL_META_DESCRIPTION)) $criteria->add(CategoryI18nTableMap::COL_META_DESCRIPTION, $this->meta_description);
    ...
    {
        $criteria = new Criteria(CategoryI18nTableMap::DATABASE_NAME);
        $criteria->add(CategoryI18nTableMap::COL_ID, $this->id);
        $criteria->add(CategoryI18nTableMap::COL_LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Plugin\Category\Model\ORM\CategoryI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Plugin\Category\Model\ORM\CategoryI18n Clone of current object.
     * @throws PropelException
     */
