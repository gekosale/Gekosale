 ...
 * @method     ChildCategoryI18nQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildCategoryI18nQuery orderByShortDescription($order = Criteria::ASC) Order by the short_description column
 ...
 * @method     ChildCategoryI18nQuery orderByMetaKeyword($order = Criteria::ASC) Order by the meta_keyword column
 ...
 * @method     ChildCategoryI18nQuery groupByName() Group by the name column
 * @method     ChildCategoryI18nQuery groupByShortDescription() Group by the short_description column
 ...
 * @method     ChildCategoryI18nQuery groupByMetaKeyword() Group by the meta_keyword column
 ...
 * @method     ChildCategoryI18n findOneByName(string $name) Return the first ChildCategoryI18n filtered by the name column
 * @method     ChildCategoryI18n findOneByShortDescription(string $short_description) Return the first ChildCategoryI18n filtered by the short_description column
 ...
 * @method     ChildCategoryI18n findOneByMetaKeyword(string $meta_keyword) Return the first ChildCategoryI18n filtered by the meta_keyword column
 ...
 * @method     array findByName(string $name) Return ChildCategoryI18n objects filtered by the name column
 * @method     array findByShortDescription(string $short_description) Return ChildCategoryI18n objects filtered by the short_description column
 ...
 * @method     array findByMetaKeyword(string $meta_keyword) Return ChildCategoryI18n objects filtered by the meta_keyword column
...
abstract class CategoryI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Category\Model\ORM\Base\CategoryI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Category\\Model\\ORM\\CategoryI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\Category\Model\ORM\CategoryI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Category\Model\ORM\CategoryI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, LOCALE, NAME, SHORT_DESCRIPTION, DESCRIPTION, META_TITLE, META_KEYWORD, META_DESCRIPTION FROM category_i18n WHERE ID = :p0 AND LOCALE = :p1';
        try {
    ...
    {
        $this->addUsingAlias(CategoryI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(CategoryI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(CategoryI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(CategoryI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(CategoryI18nTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(CategoryI18nTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_LOCALE, $locale, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByShortDescription($shortDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_SHORT_DESCRIPTION, $shortDescription, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByMetaTitle($metaTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_META_TITLE, $metaTitle, $comparison);
    }
    ...
    public function filterByMetaKeyword($metaKeyword = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_META_KEYWORD, $metaKeyword, $comparison);
    }
    ...
    public function filterByMetaDescription($metaDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::COL_META_DESCRIPTION, $metaDescription, $comparison);
    }
    ...
    public function filterByCategory($category, $comparison = null)
    {
        if ($category instanceof \Gekosale\Plugin\Category\Model\ORM\Category) {
            return $this
                ->addUsingAlias(CategoryI18nTableMap::COL_ID, $category->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CategoryI18nTableMap::COL_ID, $category->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($categoryI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CategoryI18nTableMap::COL_ID), $categoryI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(CategoryI18nTableMap::COL_LOCALE), $categoryI18n->getLocale(), Criteria::NOT_EQUAL);
