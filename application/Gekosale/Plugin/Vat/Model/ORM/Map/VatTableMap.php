...
class VatTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Plugin.Vat.Model.ORM.Map.VatTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Plugin\\Vat\\Model\\ORM\\Vat';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Plugin.Vat.Model.ORM.Vat';
    ...
    public function initialize()
    {
        ...
        $this->setName('vat');
        $this->setPhpName('Vat');
        $this->setClassName('\\Gekosale\\Plugin\\Vat\\Model\\ORM\\Vat');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Plugin\Vat\Model\ORM\Vat) { // it's a model object
