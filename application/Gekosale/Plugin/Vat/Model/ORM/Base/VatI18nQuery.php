...
abstract class VatI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Plugin\Vat\Model\ORM\Base\VatI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Plugin\\Vat\\Model\\ORM\\VatI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Plugin\Vat\Model\ORM\VatI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Plugin\Vat\Model\ORM\VatI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $this->addUsingAlias(VatI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(VatI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(VatI18nTableMap::COL_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(VatI18nTableMap::COL_LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(VatI18nTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(VatI18nTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VatI18nTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VatI18nTableMap::COL_LOCALE, $locale, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VatI18nTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByVat($vat, $comparison = null)
    {
        if ($vat instanceof \Gekosale\Plugin\Vat\Model\ORM\Vat) {
            return $this
                ->addUsingAlias(VatI18nTableMap::COL_ID, $vat->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(VatI18nTableMap::COL_ID, $vat->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($vatI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(VatI18nTableMap::COL_ID), $vatI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(VatI18nTableMap::COL_LOCALE), $vatI18n->getLocale(), Criteria::NOT_EQUAL);
