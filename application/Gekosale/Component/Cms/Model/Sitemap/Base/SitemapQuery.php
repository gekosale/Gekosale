...
use \Exception;
use \PDO;
use Gekosale\Component\Cms\Model\Sitemap\Sitemap as ChildSitemap;
...
abstract class SitemapQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Cms\Model\Sitemap\Base\SitemapQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Cms\\Model\\Sitemap\\Sitemap', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Cms\Model\Sitemap\SitemapQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Cms\Model\Sitemap\SitemapQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, NAME, PUBLISH_CATEGORIES, PRIORITY_CATEGORIES, PUBLISH_PRODUCTS, PRIORITY_PRODUCTS, PUBLISH_PRODUCERS, PRIORITY_PRODUCERS, PUBLISH_NEWS, PRIORITY_NEWS, PUBLISH_PAGES, PRIORITY_PAGES, ADD_DATE, LAST_UPDATE, PING_SERVER FROM sitemap WHERE ID = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(SitemapTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(SitemapTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::NAME, $name, $comparison);
    }
    ...
    public function filterByPublishCategories($publishCategories = null, $comparison = null)
    {
        if (is_array($publishCategories)) {
            ...
            if (isset($publishCategories['min'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_CATEGORIES, $publishCategories['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishCategories['max'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_CATEGORIES, $publishCategories['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::PUBLISH_CATEGORIES, $publishCategories, $comparison);
    }
    ...
    public function filterByPriorityCategories($priorityCategories = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PRIORITY_CATEGORIES, $priorityCategories, $comparison);
    }
    ...
    public function filterByPublishProducts($publishProducts = null, $comparison = null)
    {
        if (is_array($publishProducts)) {
            ...
            if (isset($publishProducts['min'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCTS, $publishProducts['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishProducts['max'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCTS, $publishProducts['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCTS, $publishProducts, $comparison);
    }
    ...
    public function filterByPriorityProducts($priorityProducts = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PRIORITY_PRODUCTS, $priorityProducts, $comparison);
    }
    ...
    public function filterByPublishProducers($publishProducers = null, $comparison = null)
    {
        if (is_array($publishProducers)) {
            ...
            if (isset($publishProducers['min'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCERS, $publishProducers['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishProducers['max'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCERS, $publishProducers['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::PUBLISH_PRODUCERS, $publishProducers, $comparison);
    }
    ...
    public function filterByPriorityProducers($priorityProducers = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PRIORITY_PRODUCERS, $priorityProducers, $comparison);
    }
    ...
    public function filterByPublishNews($publishNews = null, $comparison = null)
    {
        if (is_array($publishNews)) {
            ...
            if (isset($publishNews['min'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_NEWS, $publishNews['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishNews['max'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_NEWS, $publishNews['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::PUBLISH_NEWS, $publishNews, $comparison);
    }
    ...
    public function filterByPriorityNews($priorityNews = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PRIORITY_NEWS, $priorityNews, $comparison);
    }
    ...
    public function filterByPublishPages($publishPages = null, $comparison = null)
    {
        if (is_array($publishPages)) {
            ...
            if (isset($publishPages['min'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PAGES, $publishPages['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publishPages['max'])) {
                $this->addUsingAlias(SitemapTableMap::PUBLISH_PAGES, $publishPages['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::PUBLISH_PAGES, $publishPages, $comparison);
    }
    ...
    public function filterByPriorityPages($priorityPages = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PRIORITY_PAGES, $priorityPages, $comparison);
    }
    ...
    public function filterByAddDate($addDate = null, $comparison = null)
    {
        if (is_array($addDate)) {
            ...
            if (isset($addDate['min'])) {
                $this->addUsingAlias(SitemapTableMap::ADD_DATE, $addDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($addDate['max'])) {
                $this->addUsingAlias(SitemapTableMap::ADD_DATE, $addDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::ADD_DATE, $addDate, $comparison);
    }
    ...
    public function filterByLastUpdate($lastUpdate = null, $comparison = null)
    {
        if (is_array($lastUpdate)) {
            ...
            if (isset($lastUpdate['min'])) {
                $this->addUsingAlias(SitemapTableMap::LAST_UPDATE, $lastUpdate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastUpdate['max'])) {
                $this->addUsingAlias(SitemapTableMap::LAST_UPDATE, $lastUpdate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SitemapTableMap::LAST_UPDATE, $lastUpdate, $comparison);
    }
    ...
    public function filterByPingServer($pingServer = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitemapTableMap::PING_SERVER, $pingServer, $comparison);
    }
    ...
    {
        if ($sitemap) {
            $this->addUsingAlias(SitemapTableMap::ID, $sitemap->getId(), Criteria::NOT_EQUAL);
        }
