...
use Gekosale\Component\Configuration\Model\Availability\Availability;
use Gekosale\Component\Configuration\Model\Availability\AvailabilityQuery;
...
class AvailabilityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Component.Configuration.Model.Availability.Map.AvailabilityTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Component\\Configuration\\Model\\Availability\\Availability';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Component.Configuration.Model.Availability.Availability';
     ...
     */
    const ADD_DATE = 'availability.ADD_DATE';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AvailabilityTableMap::ID, AvailabilityTableMap::ADD_DATE, AvailabilityTableMap::VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AvailabilityTableMap::ID => 0, AvailabilityTableMap::ADD_DATE => 1, AvailabilityTableMap::VALUE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Component\\Configuration\\Model\\Availability\\Availability');
    ...
    {
        $this->addRelation('AvailabilityI18n', '\\Gekosale\\Component\\Configuration\\Model\\Availability\\AvailabilityI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'AvailabilityI18ns');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AvailabilityTableMap::ID);
            $criteria->addSelectColumn(AvailabilityTableMap::ADD_DATE);
            $criteria->addSelectColumn(AvailabilityTableMap::VALUE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Component\Configuration\Model\Availability\Availability) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(AvailabilityTableMap::DATABASE_NAME);
            $criteria->add(AvailabilityTableMap::ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(AvailabilityTableMap::ID) && $criteria->keyContainsValue(AvailabilityTableMap::ID) ) {
