...
abstract class Vat implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Component\\Configuration\\Model\\Vat\\Map\\VatTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Component\Configuration\Model\Vat\Base\Vat object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Gekosale\Component\Configuration\Model\Vat\Vat object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->vatI18nsScheduledForDeletion !== null) {
                if (!$this->vatI18nsScheduledForDeletion->isEmpty()) {
                    \Gekosale\Component\Configuration\Model\Vat\VatI18nQuery::create()
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Component\Configuration\Model\Vat\Vat (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Component\Configuration\Model\Vat\Vat Clone of current object.
     * @throws PropelException
     */
    ...
    public function initVatI18ns($overrideExisting = true)
    {
        ...
        $this->collVatI18ns->setModel('\Gekosale\Component\Configuration\Model\Vat\VatI18n');
    }
