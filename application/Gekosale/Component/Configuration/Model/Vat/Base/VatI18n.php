...
use \Exception;
use \PDO;
use Gekosale\Component\Configuration\Model\Vat\Vat as ChildVat;
use Gekosale\Component\Configuration\Model\Vat\VatI18nQuery as ChildVatI18nQuery;
use Gekosale\Component\Configuration\Model\Vat\VatQuery as ChildVatQuery;
...
abstract class VatI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Component\\Configuration\\Model\\Vat\\Map\\VatI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Component\Configuration\Model\Vat\Base\VatI18n object.
     * @see applyDefaults()
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[VatI18nTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Gekosale\Component\Configuration\Model\Vat\VatI18n object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Component\Configuration\Model\Vat\VatI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Component\Configuration\Model\Vat\VatI18n Clone of current object.
     * @throws PropelException
     */
