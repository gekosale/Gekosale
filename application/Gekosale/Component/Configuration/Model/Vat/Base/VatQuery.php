...
use Gekosale\Component\Configuration\Model\Vat\Map\VatTableMap;
...
abstract class VatQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Configuration\Model\Vat\Base\VatQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Configuration\\Model\\Vat\\Vat', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Configuration\Model\Vat\VatQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Configuration\Model\Vat\VatQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \Gekosale\Component\Configuration\Model\Vat\VatI18n object
     *
     * @param \Gekosale\Component\Configuration\Model\Vat\VatI18n|ObjectCollection $vatI18n  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildVatQuery The current query, for fluid interface
     */
    public function filterByVatI18n($vatI18n, $comparison = null)
    {
        if ($vatI18n instanceof \Gekosale\Component\Configuration\Model\Vat\VatI18n) {
            ...
            throw new PropelException('filterByVatI18n() only accepts arguments of type \Gekosale\Component\Configuration\Model\Vat\VatI18n or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Component\Configuration\Model\Vat\VatI18nQuery A secondary query class using the current class as primary query
     */
    public function useVatI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinVatI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'VatI18n', '\Gekosale\Component\Configuration\Model\Vat\VatI18nQuery');
    }
