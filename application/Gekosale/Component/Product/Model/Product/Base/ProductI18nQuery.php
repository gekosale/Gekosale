...
use \Exception;
use \PDO;
use Gekosale\Component\Product\Model\Product\ProductI18n as ChildProductI18n;
use Gekosale\Component\Product\Model\Product\ProductI18nQuery as ChildProductI18nQuery;
use Gekosale\Component\Product\Model\Product\Map\ProductI18nTableMap;
 ...
 * @method     ChildProductI18nQuery orderBySlug($order = Criteria::ASC) Order by the slug column
 ...
 * @method     ChildProductI18nQuery groupBySlug() Group by the slug column
 ...
 * @method     ChildProductI18n findOneBySlug(string $slug) Return the first ChildProductI18n filtered by the slug column
 ...
 * @method     array findBySlug(string $slug) Return ChildProductI18n objects filtered by the slug column
...
abstract class ProductI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Product\Model\Product\Base\ProductI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Product\\Model\\Product\\ProductI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Product\Model\Product\ProductI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Product\Model\Product\ProductI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, LOCALE, SLUG, NAME, DESCRIPTION, META_TITLE, META_KEYWORDS, META_DESCRIPTION FROM product_i18n WHERE ID = :p0 AND LOCALE = :p1';
        try {
    ...
    public function filterBySlug($slug = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProductI18nTableMap::SLUG, $slug, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProductI18nTableMap::NAME, $name, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Gekosale\Component\Product\Model\Product\Product object
     *
     * @param \Gekosale\Component\Product\Model\Product\Product|ObjectCollection $product The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProductI18nQuery The current query, for fluid interface
     */
    ...
    {
        if ($product instanceof \Gekosale\Component\Product\Model\Product\Product) {
            return $this
            ...
            throw new PropelException('filterByProduct() only accepts arguments of type \Gekosale\Component\Product\Model\Product\Product or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Component\Product\Model\Product\ProductQuery A secondary query class using the current class as primary query
     */
    public function useProductQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Product', '\Gekosale\Component\Product\Model\Product\ProductQuery');
    }
