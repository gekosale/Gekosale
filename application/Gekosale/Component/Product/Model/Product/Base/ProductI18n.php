...
abstract class ProductI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Component\\Product\\Model\\Product\\Map\\ProductI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Component\Product\Model\Product\Base\ProductI18n object.
     * @see applyDefaults()
     */
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[ProductI18nTableMap::SLUG] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ProductI18nTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductI18nTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            $this->slug = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductI18nTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProductI18nTableMap::translateFieldName('MetaKeywords', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException("Error populating \Gekosale\Component\Product\Model\Product\ProductI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductI18nTableMap::SLUG)) {
            $modifiedColumns[':p' . $index++]  = 'SLUG';
        }
        if ($this->isColumnModified(ProductI18nTableMap::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductI18nTableMap::SLUG)) $criteria->add(ProductI18nTableMap::SLUG, $this->slug);
        if ($this->isColumnModified(ProductI18nTableMap::NAME)) $criteria->add(ProductI18nTableMap::NAME, $this->name);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Component\Product\Model\Product\ProductI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Component\Product\Model\Product\ProductI18n Clone of current object.
     * @throws PropelException
     */
