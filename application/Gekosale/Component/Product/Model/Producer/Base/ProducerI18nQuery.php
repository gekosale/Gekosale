...
use \Exception;
use \PDO;
use Gekosale\Component\Product\Model\Producer\ProducerI18n as ChildProducerI18n;
 ...
 * @method     ChildProducerI18nQuery orderBySlug($order = Criteria::ASC) Order by the slug column
 * @method     ChildProducerI18nQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildProducerI18nQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildProducerI18nQuery orderByMetaTitle($order = Criteria::ASC) Order by the meta_title column
 * @method     ChildProducerI18nQuery orderByMetaKeywords($order = Criteria::ASC) Order by the meta_keywords column
 ...
 * @method     ChildProducerI18nQuery groupBySlug() Group by the slug column
 * @method     ChildProducerI18nQuery groupByName() Group by the name column
 * @method     ChildProducerI18nQuery groupByDescription() Group by the description column
 * @method     ChildProducerI18nQuery groupByMetaTitle() Group by the meta_title column
 * @method     ChildProducerI18nQuery groupByMetaKeywords() Group by the meta_keywords column
 ...
 * @method     ChildProducerI18n findOneBySlug(string $slug) Return the first ChildProducerI18n filtered by the slug column
 * @method     ChildProducerI18n findOneByName(string $name) Return the first ChildProducerI18n filtered by the name column
 * @method     ChildProducerI18n findOneByDescription(string $description) Return the first ChildProducerI18n filtered by the description column
 ...
 * @method     ChildProducerI18n findOneByMetaKeywords(string $meta_keywords) Return the first ChildProducerI18n filtered by the meta_keywords column
 ...
 * @method     array findBySlug(string $slug) Return ChildProducerI18n objects filtered by the slug column
 * @method     array findByName(string $name) Return ChildProducerI18n objects filtered by the name column
 * @method     array findByDescription(string $description) Return ChildProducerI18n objects filtered by the description column
 * @method     array findByMetaTitle(string $meta_title) Return ChildProducerI18n objects filtered by the meta_title column
 * @method     array findByMetaKeywords(string $meta_keywords) Return ChildProducerI18n objects filtered by the meta_keywords column
...
abstract class ProducerI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Product\Model\Producer\Base\ProducerI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Product\\Model\\Producer\\ProducerI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Product\Model\Producer\ProducerI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Product\Model\Producer\ProducerI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, LOCALE, SLUG, NAME, DESCRIPTION, META_TITLE, META_KEYWORDS, META_DESCRIPTION FROM producer_i18n WHERE ID = :p0 AND LOCALE = :p1';
        try {
    ...
    {
        $this->addUsingAlias(ProducerI18nTableMap::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(ProducerI18nTableMap::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(ProducerI18nTableMap::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(ProducerI18nTableMap::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ProducerI18nTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ProducerI18nTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::LOCALE, $locale, $comparison);
    }
    ...
    public function filterBySlug($slug = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::SLUG, $slug, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::NAME, $name, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByMetaTitle($metaTitle = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::META_TITLE, $metaTitle, $comparison);
    }
    ...
    public function filterByMetaKeywords($metaKeywords = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::META_KEYWORDS, $metaKeywords, $comparison);
    }
    ...
    public function filterByMetaDescription($metaDescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProducerI18nTableMap::META_DESCRIPTION, $metaDescription, $comparison);
    }

    /**
     * Filter the query by a related \Gekosale\Component\Product\Model\Producer\Producer object
     *
     * @param \Gekosale\Component\Product\Model\Producer\Producer|ObjectCollection $producer The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProducerI18nQuery The current query, for fluid interface
     */
    ...
    {
        if ($producer instanceof \Gekosale\Component\Product\Model\Producer\Producer) {
            return $this
                ->addUsingAlias(ProducerI18nTableMap::ID, $producer->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProducerI18nTableMap::ID, $producer->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByProducer() only accepts arguments of type \Gekosale\Component\Product\Model\Producer\Producer or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Component\Product\Model\Producer\ProducerQuery A secondary query class using the current class as primary query
     */
    public function useProducerQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinProducer($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Producer', '\Gekosale\Component\Product\Model\Producer\ProducerQuery');
    }
    ...
    {
        if ($producerI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(ProducerI18nTableMap::ID), $producerI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(ProducerI18nTableMap::LOCALE), $producerI18n->getLocale(), Criteria::NOT_EQUAL);
