...
use Gekosale\Component\Product\Model\Category\Category;
use Gekosale\Component\Product\Model\Category\CategoryQuery;
...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Component.Product.Model.Category.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Component\\Product\\Model\\Category\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Component.Product.Model.Category.Category';
     ...
     */
    const SORT_ORDER = 'category.SORT_ORDER';

    /**
     * the column name for the PHOTO_ID field
     */
    const PHOTO_ID = 'category.PHOTO_ID';

    /**
     * the column name for the IS_ENABLED field
     */
    const IS_ENABLED = 'category.IS_ENABLED';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'SortOrder', 'PhotoId', 'IsEnabled', 'ParentId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'sortOrder', 'photoId', 'isEnabled', 'parentId', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::ID, CategoryTableMap::SORT_ORDER, CategoryTableMap::PHOTO_ID, CategoryTableMap::IS_ENABLED, CategoryTableMap::PARENT_ID, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'SORT_ORDER', 'PHOTO_ID', 'IS_ENABLED', 'PARENT_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'sort_order', 'photo_id', 'is_enabled', 'parent_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'SortOrder' => 1, 'PhotoId' => 2, 'IsEnabled' => 3, 'ParentId' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'sortOrder' => 1, 'photoId' => 2, 'isEnabled' => 3, 'parentId' => 4, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::ID => 0, CategoryTableMap::SORT_ORDER => 1, CategoryTableMap::PHOTO_ID => 2, CategoryTableMap::IS_ENABLED => 3, CategoryTableMap::PARENT_ID => 4, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'SORT_ORDER' => 1, 'PHOTO_ID' => 2, 'IS_ENABLED' => 3, 'PARENT_ID' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'sort_order' => 1, 'photo_id' => 2, 'is_enabled' => 3, 'parent_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Component\\Product\\Model\\Category\\Category');
        ...
        $this->addColumn('PARENT_ID', 'ParentId', 'INTEGER', false, 10, null);
    } // initialize()
    ...
    {
        $this->addRelation('CategoryI18n', '\\Gekosale\\Component\\Product\\Model\\Category\\CategoryI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'CategoryI18ns');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::SORT_ORDER);
            $criteria->addSelectColumn(CategoryTableMap::PHOTO_ID);
            $criteria->addSelectColumn(CategoryTableMap::IS_ENABLED);
            $criteria->addSelectColumn(CategoryTableMap::PARENT_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Component\Product\Model\Category\Category) { // it's a model object
