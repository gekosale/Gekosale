...
namespace Gekosale\Component\Product\Model\Category\Map;

use Gekosale\Component\Product\Model\Category\CategoryI18n;
use Gekosale\Component\Product\Model\Category\CategoryI18nQuery;
...
class CategoryI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gekosale.Component.Product.Model.Category.Map.CategoryI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Gekosale\\Component\\Product\\Model\\Category\\CategoryI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gekosale.Component.Product.Model.Category.CategoryI18n';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CategoryI18nTableMap::ID, CategoryI18nTableMap::LOCALE, CategoryI18nTableMap::SLUG, CategoryI18nTableMap::NAME, CategoryI18nTableMap::DESCRIPTION, CategoryI18nTableMap::META_TITLE, CategoryI18nTableMap::META_KEYWORDS, CategoryI18nTableMap::META_DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CategoryI18nTableMap::ID => 0, CategoryI18nTableMap::LOCALE => 1, CategoryI18nTableMap::SLUG => 2, CategoryI18nTableMap::NAME => 3, CategoryI18nTableMap::DESCRIPTION => 4, CategoryI18nTableMap::META_TITLE => 5, CategoryI18nTableMap::META_KEYWORDS => 6, CategoryI18nTableMap::META_DESCRIPTION => 7, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gekosale\\Component\\Product\\Model\\Category\\CategoryI18n');
        $this->setPackage('Gekosale.Component.Product.Model.Category');
    ...
    {
        $this->addRelation('Category', '\\Gekosale\\Component\\Product\\Model\\Category\\Category', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \Gekosale\Component\Product\Model\Category\CategoryI18n $obj A \Gekosale\Component\Product\Model\Category\CategoryI18n object.
     ...
     *
     * @param mixed $value A \Gekosale\Component\Product\Model\Category\CategoryI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Gekosale\Component\Product\Model\Category\CategoryI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Gekosale\Component\Product\Model\Category\CategoryI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryI18nTableMap::SLUG);
            $criteria->addSelectColumn(CategoryI18nTableMap::NAME);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gekosale\Component\Product\Model\Category\CategoryI18n) { // it's a model object
