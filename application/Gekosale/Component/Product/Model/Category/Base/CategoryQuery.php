 ...
 * @method     ChildCategoryQuery orderBySortOrder($order = Criteria::ASC) Order by the sort_order column
 ...
 * @method     ChildCategoryQuery groupBySortOrder() Group by the sort_order column
 ...
 * @method     ChildCategory findOneBySortOrder(int $sort_order) Return the first ChildCategory filtered by the sort_order column
 ...
 * @method     array findBySortOrder(int $sort_order) Return ChildCategory objects filtered by the sort_order column
 ...
 * @method     array findByParentId(int $parent_id) Return ChildCategory objects filtered by the parent_id column
 *
 */
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Product\Model\Category\Base\CategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Product\\Model\\Category\\Category', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Product\Model\Category\CategoryQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Product\Model\Category\CategoryQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, SORT_ORDER, PHOTO_ID, IS_ENABLED, PARENT_ID FROM category WHERE ID = :p0';
        try {
    ...
    public function filterBySortOrder($sortOrder = null, $comparison = null)
    {
        if (is_array($sortOrder)) {
            ...
            if (isset($sortOrder['min'])) {
                $this->addUsingAlias(CategoryTableMap::SORT_ORDER, $sortOrder['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($sortOrder['max'])) {
                $this->addUsingAlias(CategoryTableMap::SORT_ORDER, $sortOrder['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::SORT_ORDER, $sortOrder, $comparison);
    }
    ...
    public function filterByPhotoId($photoId = null, $comparison = null)
    {
        if (is_array($photoId)) {
            ...
            if (isset($photoId['min'])) {
                $this->addUsingAlias(CategoryTableMap::PHOTO_ID, $photoId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($photoId['max'])) {
                $this->addUsingAlias(CategoryTableMap::PHOTO_ID, $photoId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::PHOTO_ID, $photoId, $comparison);
    }
    ...
    public function filterByIsEnabled($isEnabled = null, $comparison = null)
    {
        if (is_array($isEnabled)) {
            ...
            if (isset($isEnabled['min'])) {
                $this->addUsingAlias(CategoryTableMap::IS_ENABLED, $isEnabled['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($isEnabled['max'])) {
                $this->addUsingAlias(CategoryTableMap::IS_ENABLED, $isEnabled['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::IS_ENABLED, $isEnabled, $comparison);
    }
    ...
    public function filterByParentId($parentId = null, $comparison = null)
    {
        if (is_array($parentId)) {
            ...
            if (isset($parentId['min'])) {
                $this->addUsingAlias(CategoryTableMap::PARENT_ID, $parentId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($parentId['max'])) {
                $this->addUsingAlias(CategoryTableMap::PARENT_ID, $parentId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::PARENT_ID, $parentId, $comparison);
    }

    /**
     * Filter the query by a related \Gekosale\Component\Product\Model\Category\CategoryI18n object
     *
     * @param \Gekosale\Component\Product\Model\Category\CategoryI18n|ObjectCollection $categoryI18n  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCategoryQuery The current query, for fluid interface
     */
    ...
    {
        if ($categoryI18n instanceof \Gekosale\Component\Product\Model\Category\CategoryI18n) {
            return $this
            ...
            throw new PropelException('filterByCategoryI18n() only accepts arguments of type \Gekosale\Component\Product\Model\Category\CategoryI18n or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Component\Product\Model\Category\CategoryI18nQuery A secondary query class using the current class as primary query
     */
    public function useCategoryI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinCategoryI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CategoryI18n', '\Gekosale\Component\Product\Model\Category\CategoryI18nQuery');
    }
