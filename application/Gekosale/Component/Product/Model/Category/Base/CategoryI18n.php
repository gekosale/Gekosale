...
abstract class CategoryI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Gekosale\\Component\\Product\\Model\\Category\\Map\\CategoryI18nTableMap';
    ...
    /**
     * Initializes internal state of Gekosale\Component\Product\Model\Category\Base\CategoryI18n object.
     * @see applyDefaults()
     */
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[CategoryI18nTableMap::SLUG] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CategoryI18nTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryI18nTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            $this->slug = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoryI18nTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategoryI18nTableMap::translateFieldName('MetaKeywords', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException("Error populating \Gekosale\Component\Product\Model\Category\CategoryI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryI18nTableMap::SLUG)) {
            $modifiedColumns[':p' . $index++]  = 'SLUG';
        }
        if ($this->isColumnModified(CategoryI18nTableMap::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryI18nTableMap::SLUG)) $criteria->add(CategoryI18nTableMap::SLUG, $this->slug);
        if ($this->isColumnModified(CategoryI18nTableMap::NAME)) $criteria->add(CategoryI18nTableMap::NAME, $this->name);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Gekosale\Component\Product\Model\Category\CategoryI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Gekosale\Component\Product\Model\Category\CategoryI18n Clone of current object.
     * @throws PropelException
     */
