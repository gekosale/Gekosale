...
use Gekosale\Component\Product\Model\Category\Map\CategoryI18nTableMap;
 ...
 * @method     ChildCategoryI18nQuery orderBySlug($order = Criteria::ASC) Order by the slug column
 ...
 * @method     ChildCategoryI18nQuery groupBySlug() Group by the slug column
 ...
 * @method     ChildCategoryI18n findOneBySlug(string $slug) Return the first ChildCategoryI18n filtered by the slug column
 ...
 * @method     array findBySlug(string $slug) Return ChildCategoryI18n objects filtered by the slug column
...
abstract class CategoryI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Gekosale\Component\Product\Model\Category\Base\CategoryI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gekosale\\Component\\Product\\Model\\Category\\CategoryI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Gekosale\Component\Product\Model\Category\CategoryI18nQuery) {
            return $criteria;
        }
        $query = new \Gekosale\Component\Product\Model\Category\CategoryI18nQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, LOCALE, SLUG, NAME, DESCRIPTION, META_TITLE, META_KEYWORDS, META_DESCRIPTION FROM category_i18n WHERE ID = :p0 AND LOCALE = :p1';
        try {
    ...
    public function filterBySlug($slug = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::SLUG, $slug, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryI18nTableMap::NAME, $name, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Gekosale\Component\Product\Model\Category\Category object
     *
     * @param \Gekosale\Component\Product\Model\Category\Category|ObjectCollection $category The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCategoryI18nQuery The current query, for fluid interface
     */
    ...
    {
        if ($category instanceof \Gekosale\Component\Product\Model\Category\Category) {
            return $this
            ...
            throw new PropelException('filterByCategory() only accepts arguments of type \Gekosale\Component\Product\Model\Category\Category or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Gekosale\Component\Product\Model\Category\CategoryQuery A secondary query class using the current class as primary query
     */
    public function useCategoryQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinCategory($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Category', '\Gekosale\Component\Product\Model\Category\CategoryQuery');
    }
