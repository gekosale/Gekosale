...
<h2 style="font-size:14px; color:#231f20; border-bottom:1px solid #e3e3e3; padding-bottom:4px; margin-top:30px; text-transform:uppercase;">{% trans %}TXT_CONTACT_DATA{% endtrans %}</h2>
<p>
<br>{% trans %}TXT_PHONE{% endtrans %}: {{ order.contactData.phone }} 
{% if order.contactData.phone2 != "" %}<br>{% trans %}TXT_ADDITIONAL_PHONE{% endtrans %}: {{ order.contactData.phone2 }}{% endif %}
<br>{% trans %}TXT_EMAIL{% endtrans %}: {{ order.contactData.email }} 
</p>
