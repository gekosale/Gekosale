...
class RadarModel extends Component\Model
{

	public function getDescription ()
	{
		return '<strong>Radar.pl</strong> to nowoczesna porównywarka cen w sklepach internetowych. Naszym najważniejszym celem jest pomaganie konsumentom w znalezieniu jak najlepszych propozycji kupna różnorodnych produktów. W tym celu zbieramy miliony ofert z setek sklepów internetowych i porównujemy je ze sobą.';
	}
