	...
	public function initForm ()
	{
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			...
			'rules' => Array(
				...
				new FormEngine\Rules\LanguageUnique($this->trans('ERR_NAME_ALREADY_EXISTS'), 'producertranslation', 'name', null, Array(
					'column' => 'producerid',
		...
		$requiredData->AddChild(new FormEngine\Elements\StaticText(Array(
			'text' => '<p style="padding-left: 195px;"><a href="' . App::getURLAdressWithAdminPane() . 'deliverer/add' . '" target="_blank"><span>' . $this->trans('TXT_ADD_DELIVERER') . '</span></a></p>'
		)));
